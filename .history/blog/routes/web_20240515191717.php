...
//打工搜尋
Route::get('/shop_search', [IndexController::class, 'shop_search'])->name('shop_search');
//打工搜尋
Route::get('/mjoin_search', [IndexController::class, 'mjoin_search'])->name('mjoin_search');
...
Route::middleware([admin_verity::class])->group(function () {
    ...
    //管理者揪團單獨顯示
    Route::get('/user_mjoin_solo_{mjoinId}', [AdminController::class, 'user_mjoin_solo'])->name('user_mjoin_solo');
    //管理者打工單獨顯示
    Route::get('/user_shop_solo_{shopId}', [AdminController::class, 'user_shop_solo'])->name('user_shop_solo');
    //管理者創作單獨顯示    
    Route::get('/user_artwork_solo_{artId}', [AdminController::class, 'user_artwork_solo'])->name('user_artwork_solo');
    //登出
    ...
    //揪團編輯
    Route::get('/user_cms_mjoin_edit_{mjoinId}', [AdminController::class, 'user_cms_mjoin_edit'])->name('user_cms_mjoin_edit');
    //打工編輯
    Route::get('/user_cms_shop_edit_{shopId}', [AdminController::class, 'user_cms_shop_edit'])->name('user_cms_shop_edit');
    //創作編輯
    Route::get('/user_cms_artwork_edit_{shopId}', [AdminController::class, 'user_cms_artwork_edit'])->name('user_cms_artwork_edit');
    //揪團編輯送出
    Route::post('/user_cms_mjoin_edit_submit/{mjoinId}', [AdminController::class, 'user_cms_mjoin_edit_submit'])->name('user_cms_mjoin_edit_submit');
    //打工編輯送出
    Route::post('/user_cms_shop_edit_submit/{shopId}', [AdminController::class, 'user_cms_shop_edit_submit'])->name('user_cms_shop_edit_submit');
    //創作編輯送出
    Route::post('/user_cms_artwork_edit_submit/{artId}', [AdminController::class, 'user_cms_artwork_edit_submit'])->name('user_cms_artwork_edit_submit');
    //揪團刪除
    Route::post('/user_mjoin_delete_{mjoinId}', [AdminController::class, 'user_mjoin_delete'])->name('user_mjoin_delete');
    //揪團刪除回復
    Route::get('/user_mjoin_delete_back_{mjoinId}', [AdminController::class, 'user_mjoin_delete_back'])->name('user_mjoin_delete_back');
    //打工刪除
    Route::post('/user_shop_delete_{shopId}', [AdminController::class, 'user_shop_delete'])->name('user_shop_delete');
    //打工刪除回復
    Route::get('/user_shop_delete_back_{shopId}', [AdminController::class, 'user_shop_delete_back'])->name('user_shop_delete_back');
    //創作刪除
    Route::post('/user_artwork_delete_{artId}', [AdminController::class, 'user_artwork_delete'])->name('user_artwork_delete');
    //創作刪除回復
    Route::get('/user_artwork_delete_back_{artId}', [AdminController::class, 'user_artwork_delete_back'])->name('user_artwork_delete_back');
});
//login
