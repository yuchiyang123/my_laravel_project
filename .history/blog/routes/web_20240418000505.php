...
//電話檢查
Route::get('/user_phone', [UserController::class, 'user_phone'])->name('user_phone');
//電話驗證轉變
Route::get('/user_phone_verify', [UserController::class, 'user_phone_verify'])->name('user_phone_verify');
