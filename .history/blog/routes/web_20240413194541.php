...
//創作按讚
Route::get('/art_post_posts/good/{mjoinId}', [UserGoodArkController::class, 'mjoin_post_good'])->name('mjoin_post_good');
//創作按讚取消
Route::get('/art_post_posts/ungood/{mjoinId}', [UserGoodArkController::class, 'mjoin_post_ungood'])->name('mjoin_post_ungood');
//創作檢查讚
Route::get('/art_post_posts/checkgood/{mjoinId}', [UserGoodArkController::class, 'mjoin_post_checkgood'])->name('mjoin_post_checkgood');
//創作讚數
Route::get('/art_post_posts/countgood/{mjoinId}', [UserGoodArkController::class, 'mjoin_post_countgood'])->name('mjoin_post_countgood');
