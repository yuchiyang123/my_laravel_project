...
Route::middleware([admin_verity::class])->group(function () {
    ...
    //創作刪除
    Route::post('/user_artwork_delete_{artId}', [AdminController::class, 'user_shop_delete'])->name('user_shop_delete');
    //創作刪除回復
    Route::get('/user_artwork_delete_back_{artId}', [AdminController::class, 'user_shop_delete_back'])->name('user_shop_delete_back');
});
//login
