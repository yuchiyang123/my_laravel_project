...
Route::middleware([admin_verity::class])->group(function () {
    ...
    //揪團刪除回復
    Route::post('/user_mjoin_delete_back_{mjoinId}', [AdminController::class, 'user_mjoin_delete_back'])->name('user_mjoin_delete_back');
    //打工刪除
    Route::post('/user_shop_delete_{shopId}', [AdminController::class, 'user_shop_delete'])->name('user_shop_delete');
    //打工刪除回復
    Route::post('/user_shop_delete_back_{shopId}', [AdminController::class, 'user_shop_delete_back'])->name('user_shop_delete_back');
    //創作刪除
    Route::post('/user_artwork_delete_{artId}', [AdminController::class, 'user_artwork_delete'])->name('user_artwork_delete');
    //創作刪除回復
    Route::post('/user_artwork_delete_back_{artId}', [AdminController::class, 'user_artwork_delete_back'])->name('user_artwork_delete_back');
});
//login
