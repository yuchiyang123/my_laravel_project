...
Route::middleware([admin_verity::class])->group(function () {
    ...
    //審核店家申請通過
    Route::post('/shop_apply_pass/{userId}', [AdminController::class, 'shop_apply_pass'])->name('shop_apply_pass');
    //審核店家申請不通過
    Route::post('/shop_apply_reject/{userId}', [AdminController::class, 'shop_apply_reject'])->name('shop_apply_reject');
