...
Route::get('/', [UserController::class, 'index'])->middleware(sessionMiddleware::class);
Route::get('/index', [IndexController::class, 'index'])->name('index')->middleware(sessionMiddleware::class);
/*
Route::get('/home', function () {
    return view('home');
})->name('home');*/
Route::get('/login', [UserController::class, 'index'])->name('login')->middleware(sessionMiddleware::class);
//揪團
Route::get('/front-view', [UserMjoinController::class, 'mjoin'])->name('front')->middleware(sessionMiddleware::class);
//揪團資料庫
...
//驗證電話表單
Route::get('/user_verify_phone', [UserController::class, 'showform'])->name('verify_phone')->middleware(sessionMiddleware::class);
//電話檢查
...
Route::post('/login/submit', [UserController::class, 'login'])->name('user.login')->middleware(sessionMiddleware::class);
