...
//打工編輯表單
Route::get('/shop_post_posts/edit/{shopd}', [UserController::class, 'shop_edit'])->name('shop_edit');
//打工編輯
Route::post('/shop_post_posts/edit/update/{shopId}', [UserMjoinController::class, 'shop_post_edit'])->name('shop_post_edit');
//打工刪除
Route::post('/shop_post_posts/edit/delete/{shopId}', [UserMjoinController::class, 'shop_post_delete'])->name('shop_post_delete');
//打工收藏
...
//打工獨立顯示
Route::get('/shop_solo/{shopId}', [UserController::class, 'user_shop_solo'])->name('user_shop_solo');
