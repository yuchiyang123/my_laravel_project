...
Route::middleware([admin_verity::class])->group(function () {
    ...
    //停權
    Route::get('/user_stop/{userId}', [AdminController::class, 'user_stop'])->name('user_stop');
    //恢復
    Route::get('/user_resume/{userId}', [AdminController::class, 'user_resume'])->name('user_resume');
    //刪除
    Route::get('/user_delete/{userId}', [AdminController::class, 'user_delete'])->name('user_delete');
