...
//訊息顯示
Route::get('/message-view-show/t/{senderu}',[UserMessageController::class , 'message_show'])->name('message_view_show');
//訊息單獨顯示
Route::get('/message-view-show/{senderu}', [UserMessageController::class, 'message_show_solo'])->name('message_view_solo');

//Route::get('/message-view-show/t/{senderu}', [UserMessageController::class , 'message_show'])->name('Message_d');
//訊息傳送
