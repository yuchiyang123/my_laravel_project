...
//驗證電話送出簡訊
Route::get('/user_verify_phone/{phone}', [UserController::class, 'sendVerificationCode'])->name('verify_phone');
//驗證電話
Route::get('/user_verify_phone_submit/{phone}', [UserController::class, 'verify_phone_submit'])->name('verify_phone_submit');
