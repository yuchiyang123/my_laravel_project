...
use App\Http\Controllers\User_collections_shop;
use App\Http\Controllers\User_collections_mjoin;
use App\Http\Controllers\User_collections_artwork;
...
//創作收藏
Route::get('/collect_artwork/collect/{article_id}', [User_collections_artwork::class, 'collection_artwork'])->name('collect_artwork');
//揪團收藏
Route::get('/collect_mjoin/collect/{article_id}', [User_collections_mjoin::class, 'collection_mjoin'])->name('collect_mjoin');
//打工收藏
Route::get('/collect_work/collect/{article_id}', [User_collections_shop::class, 'collection_work'])->name('collect_shop');
