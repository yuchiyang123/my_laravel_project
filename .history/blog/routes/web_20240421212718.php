...
//審核通過
Route::post('/review_mjoin_pass/{mjoind}', [UserJoinController::class, 'review_mjoin_pass'])->name('review_mjoin_pass');
//審核不通過
Route::post('/review_mjoin_reject/{mjoind}', [UserJoinController::class, 'review_mjoin_reject'])->name('review_mjoin_reject');
