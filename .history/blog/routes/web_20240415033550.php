...
//驗證電話表單
Route::post('/user_verify_phone', function () {return view('auth.verify_phone');});
//驗證電話送出簡訊
Route::post('/user_verify_phone/{phone}', [UserController::class, 'sendVerificationCode'])->name('sendVerificationCode');
//驗證電話
Route::post('/user_verify_phone_submit/{phone}', [UserController::class, 'verify_phone'])->name('verify_phone_submit');
