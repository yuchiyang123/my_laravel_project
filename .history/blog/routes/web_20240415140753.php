...
//驗證電話表單
Route::get('/user_verify_phone', function () {return view('auth.verify_phone');})->name('verify_phone');
//驗證電話
Route::post('/phone_verification/verify', [UserController::class, 'verify'])->name('phone_verification.verify');
//驗證電話送出簡訊
Route::post('/user_verify_phone_send/send', [UserController::class, 'sendVerificationCode'])->name('sendVerificationCode');
//驗證電話
