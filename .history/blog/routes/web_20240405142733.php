...
//訊息單獨顯示
Route::get('/message-view-show/{senderu}', [UserMessageController::class, 'message_show_solo']);
//訊息傳送
Route::post('/message-submit/{senderu}/{receiveru}', [UserMjoinController::class, 'message_submit'])->name('front.reply.submit');
