    ...
    public function allnotify(){
        ...
        if(!Auth::check()){
            return redirect('/login');
                ...
                $query5 = DB::table('join_mjoin')
                                ->select('join_mjoin.*','mjoin.id','user.profileImage', 'user.profileImage_type', DB::raw('NULL as additional_field'), DB::raw('"notify_join_mjoin" as source'))
        ...
        foreach ($notifications as $notification) {
            ...
            if ($notification->source === 'reply_artwork') {
                ...
                $url_join = '/join_mjoin_verify/' . $notification->id;
