...
class UserJoinController extends Controller
{
    ...
    public function join_mjoin_submit(Request $request,$mjoinId){
        ...
        $User_join_mjoin->sex = $request->sex;
        $User_join_mjoin->age = $request->age;
        $User_join_mjoin->preferences = $request->preferences[];
        $User_join_mjoin->languages = $request->languages;
        $User_join_mjoin->license = $request->license;
        $User_join_mjoin->contact_method = $request->contact_method;
        $User_join_mjoin->editor = $request->editor;
