        ...
        if(!Auth::check()){
            return redirect('/login');
                ...
                $query5 = DB::table('notify_join_mjoin')
                                ->select('notify_join_mjoin.*','mjoin.id','user.profileImage', 'user.profileImage_type', DB::raw('NULL as additional_field'), DB::raw('"notify_join_mjoin" as source'))
                ...
                $query6 = DB::table('shop_join')
                                ->select('shop_join.*', 'user.profileImage', 'user.profileImage_type', DB::raw('NULL as additional_field'), DB::raw('"notify_join_mjoin" as source'))
