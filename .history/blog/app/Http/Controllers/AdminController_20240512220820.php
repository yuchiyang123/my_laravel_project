...
class AdminController extends Controller
{
    ...
    {   
        ...
        $profile_image_url = 'data:' . $shop_apply->profileImage_type . ';base64,' . base64_encode($shop_apply->profileImage);
        $profile_image_url1 = 'data:' . $shop_apply->profileImage_type1 . ';base64,' . base64_encode($shop_apply->profileImage1);
