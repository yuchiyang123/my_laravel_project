...
class UserController extends Controller
{
    ...
    public function sendVerificationCode(Request $request, $phone)
    {
        ...
        // 获取 Firebase 服务帐户 JSON 文件路径
        $firebaseCredentialsPath = storage_path('firebase/project-410302-firebase-adminsdk-g5wrh-12f1881e62.json');
        dd(ServiceAccount::fromJsonFile($firebaseCredentialsPath));
        // 初始化 Firebase
        ...
        // 發送短信驗證碼
        $auth->startPhoneNumberVerification($phone, [
            'code' => $code,
            'timeout' => 300, // 驗證碼有效時間，單位為秒
        ]);

        // 將驗證碼存儲到 session 中，以便後續驗證
