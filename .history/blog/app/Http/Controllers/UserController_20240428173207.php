...
class UserController extends Controller
{
    ...
    public function user_data($username)
    {
            ...
            $usercollections = DB::table('user_profile')
                              ...
                              ->leftJoin('mjoin','user_collections_mjoin.user_id','=','mjoin.id')
                              ->leftJoin('shop','user_collections_shop.user_id','=','shop.id')
                              ->leftJoin('artwork','user_collections_artwork.user_id','=','artwork.id')
                              ->where('user.username',$username)
                              ->where('artwork.status','<>','del')
            ...
            return view('auth.userprofile', compact('userrecord' ,'userarkworks','userinfo'));
