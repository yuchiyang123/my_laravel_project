...
class UserController extends Controller
{
    ...
    public function user_collections_all($username)
    {
        ...
        if($userinfo->favorite_articles_visibility=='public' || $username == Auth::user()->username){
            return view('auth.all_collect', compact('userinfo','userCollections','userCollections_mjoin','userCollections_shop'));
        } else {
            return view('/user-profile/index/d/'.$username)->with('error','該用戶未開啟收藏功能');
        }
    }
    //用戶資料
