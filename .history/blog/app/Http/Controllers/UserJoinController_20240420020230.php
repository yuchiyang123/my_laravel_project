...
class UserJoinController extends Controller
{
    ...
    public function join_mjoin_submit(Request $request,$mjoinId){
        ...
        $User_join_mjoin->preferences = $request->input('preferences');
        $User_join_mjoin->languages =$request->input('languages');
        $User_join_mjoin->license = $request->input('license');
        $User_join_mjoin->contact_method = $request->input('contact_method');
