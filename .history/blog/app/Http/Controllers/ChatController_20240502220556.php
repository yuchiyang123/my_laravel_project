...
class ChatController extends Controller
{
    ...
    public function message_d($receiver_id)
    {
        $messages = Messagenew::where('user_id',Auth::user()->id)->get();

        return view('auth.Message', compact('messages','messagessolo','receiver_id'));
    }
