    ...
    public function user_data($username)
    {
           ...
           $userid = User::select('id')->where('username',$username)->first();
            ...
            $userinfo = DB::table('user_profile')
                              ...
                              ->leftJoin('user', 'user_profile.user_id', '=', 'user.id')
                              ->leftJoin('user_collections_artwork', 'user_profile.user_id', '=', 'user_collections_artwork.user_id')
                              ->leftJoin('user_collections_mjoin', 'user_profile.user_id', '=', 'user_collections_mjoin.user_id')
                              ->leftJoin('user_collections_shop', 'user_profile.user_id', '=', 'user_collections_shop.user_id')
