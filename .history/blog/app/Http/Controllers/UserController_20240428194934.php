...
class UserController extends Controller
{
    ...
    public function user_data($username)
    {
            ...
            $userinfo = DB::table('user_profile')
                              ...
                              $usercollections = DB::table('user')
                              ->select('user.*', 'user.id as user-id', 'user_collections_artwork.*', 'user_collections_mjoin.*', 'user_collections_shop.*')
                              ->leftJoin('user_collections_artwork', 'user.id', '=', 'user_collections_artwork.user_id')
                              ->leftJoin('user_collections_mjoin', 'user.id', '=', 'user_collections_mjoin.user_id')
                              ->leftJoin('user_collections_shop', 'user.id', '=', 'user_collections_shop.user_id')
                              ->orleftJoin('mjoin', 'user_collections_mjoin.article_id', '=', 'mjoin.id')
                                ->orleftJoin('shop', 'user_collections_shop.article_id', '=', 'shop.id')
                                ->orleftJoin('artwork', 'user_collections_artwork.article_id', '=', 'artwork.id')
                              ->where('user.username', $username)
                              ->where(function($query) use ($userid) {
                                  $query->orwhere('user_collections_artwork.user_id', $userid)
                                        ->orWhere('user_collections_mjoin.user_id', $userid)
                                        ->orWhere('user_collections_shop.user_id', $userid);
                              })
                              ...
                              ->orderBy('user_collections_shop.id', 'desc')
                              ->orderBy('user_collections_artwork.id', 'desc')
                              ->orderBy('user_collections_mjoin.id', 'desc')
                              ->get(); 
            ...
            return view('auth.userprofile', compact('userrecord' ,'userarkworks','userinfo','usercollections'));
