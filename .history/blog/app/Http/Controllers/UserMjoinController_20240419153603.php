                ...
                <div class="limt">
                    <div class="image-container">
                        <a href="/user-profile/index/d/'.$allmjoin->posted_by_u.'">
                            <img src="' . ($allmjoin->profileImage ? $imageData : 'https://bootdey.com/img/Content/avatar/avatar1.png') . '" class="img-fluid avatar-xxl rounded-circle" style="width: 40px;" alt="">
                        </a>
                    </div>
