...
class UserWorkController extends Controller
{
    ...
    {
        $shops = DB::table('shop')
                               ->select('shop.*','shop.id as shop_join_id', 'user_collections_shop.status as status_b', 'user.profileImage_type', 'user.profileImage')
