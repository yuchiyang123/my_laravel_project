...
class UserController extends Controller
{
    ...
    public function user_data($username)
    {
           ...
           $userid = User::select('id')->where('username',$username)->first();
            ...
            $usercollections = DB::table('user_profile')
                              ->select('user_profile.*', 'user.id as user-id', 'user_collections_artwork.*', 'user_collections_mjoin.*', 'user_collections_shop.*')
                              ->leftJoin('user', 'user_profile.user_id', '=', 'user.id')
                              ->rightJoin('user_collections_artwork', 'user_profile.user_id', '=', 'user_collections_artwork.user_id')
                              ->rightJoin('user_collections_mjoin', 'user_profile.user_id', '=', 'user_collections_mjoin.user_id')
                              ->rightJoin('user_collections_shop', 'user_profile.user_id', '=', 'user_collections_shop.user_id')
                              ->rightJoin('mjoin', 'user_collections_mjoin.article_id', '=', 'mjoin.id')
                              ->rightJoin('shop', 'user_collections_shop.article_id', '=', 'shop.id')
                              ->rightJoin('artwork', 'user_collections_artwork.article_id', '=', 'artwork.id')
                              ->where('user.username', $username)
