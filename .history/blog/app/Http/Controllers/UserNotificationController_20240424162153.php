            ...
            return redirect('/login');
                ...
                $query4 = DB::table('great_arkwork')
                    ...
                    $query5 = DB::table('notify_join_mjoin')
                                ->select('notify_join_mjoin.*', 'shop_join.*', 'user.profileImage', 'user.profileImage_type', DB::raw('NULL as additional_field'), DB::raw('"notify_join_mjoin" as source'))
                                ->leftJoin('user', 'notify_join_mjoin.user_id', '=', 'user.id')
                                ->leftJoin('shop_join', 'shop_join.user_id', '=', 'user.id')
                                ...
                                ->orderBy('notify_join_mjoin.updated_at','shop_join.updated_at', 'desc')
                                ->get();
