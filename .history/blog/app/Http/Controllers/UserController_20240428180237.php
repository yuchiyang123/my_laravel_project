    ...
    public function user_data($username)
    {
           ...
           $userid = User::select('id')->where('username',$username)->first();
            ...
            $usercollections = DB::table('user')
                              ...
                              ->join('user_collections_artwork', 'user.id', '=', 'user_collections_artwork.user_id')
                              ->join('user_collections_mjoin', 'user.id', '=', 'user_collections_mjoin.user_id')
                              ->join('user_collections_shop', 'user.id', '=', 'user_collections_shop.user_id')
                              ->where('user.username', $username)
