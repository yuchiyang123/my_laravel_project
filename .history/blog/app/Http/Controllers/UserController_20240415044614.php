...
class UserController extends Controller
{
    ...
    public function sendVerificationCode(Request $request, $phone)
    {
        ...
        // 获取 Firebase 工厂实例
        $factory = (new Factory)->withServiceAccount(storage_path('firebase/project-410302-firebase-adminsdk-g5wrh-12f1881e62.json'));

        // 获取身份验证实例
        $auth = $factory->createAuth();

        // 发送短信验证码
        $actionLink = SendActionLink::forVerification($phone);
        $response = $auth->sendOobLinkToPhoneNumber($phone, $actionLink);
