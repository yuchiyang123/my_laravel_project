...
class UserController extends Controller
{
    ...
    public function user_data($username)
    {
            ...
            return view('auth.userprofile', compact('userrecord' ,'userarkworks','userinfo','userCollections','userCollections_mjoin','userCollections_shop','averageScore','$averageScore_shop'));
