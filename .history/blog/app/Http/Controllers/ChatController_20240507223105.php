...
class ChatController extends Controller
{
    ...
    public function message_d()
    {
        ...
        $results = Messagenew::leftJoin('messages as m1', 'users.user_id', '=', 'm1.user_id')
                        ->leftJoin('messages as m2', 'users.user_id', '=', 'm2.receiver_id')
                        ->select('users.username as user_username', 'm2.username as receiver_username')
                        ->whereNull('m1.user_id')
                        ->orWhereNull('m2.receiver_id')
                        ->get();
