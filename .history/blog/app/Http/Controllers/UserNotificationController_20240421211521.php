        ...
        if(!Auth::check()){
            return redirect('/login');
                ...
                $query5 = DB::table('notify_join_mjoin')
                    ->select('notify_join_mjoin.*','notify_join_mjoin.id as notify_join_mjoin_id', 'user.profileImage', 'user.profileImage_type', DB::raw('NULL as additional_field'), DB::raw('"notify_join_mjoin" as source'))
