...
class UserNotificationController extends Controller
{
    public function allnotify(){
        ...
        foreach ($notifications as $notification) {
            ...
            // 生成通知 HTML 内容
            $htmlContent .= '<li><a class="dropdown-item" href="' . $imageDataUri . '" id="join_normalnotify">';
            $htmlContent .= '<img src="' . $notification->profileImage . '" alt="mdo" width="50" height="50" class="rounded-circle">';
