...
class UserJoinController extends Controller
{
    ...
    public function review_mjoin_form($joinId)
    {
        ...
        return view('auth.review_join_mjoin', compact('review_join_mjoin','review_join_user','age','averageTotalScore'));
    ...
    public function review_shop_form($joinId)
    {
        ...
        //$age = Carbon::parse($review_join_mjoin->age)->age;
        return view('auth.review_join_shop', compact('review_join_shop','review_join_user','averageTotalScore'));
