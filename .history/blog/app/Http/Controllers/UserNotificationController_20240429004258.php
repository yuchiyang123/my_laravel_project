        ...
        if(!Auth::check()){
            return redirect('/login');
                ...
                $query5 = DB::table('join_mjoin')
                                ->select('join_mjoin.id as join_id','join_mjoin.*','mjoin.id','user.profileImage', 'user.profileImage_type', DB::raw('NULL as additional_field'), DB::raw('"notify_join_mjoin" as source'))
