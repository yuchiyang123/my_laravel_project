            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  <a href="/user_mjoin_delete_{{ $mjoin->id }}"><button class="btn btn-danger btn-sm" href="#" data-toggle="modal" data-target="#modal-secondary">刪除</button></a>
                </td>
              </tr>
            ...
            <div class="modal fade" id="modal-secondary">
              <div class="modal-dialog">
                <div class="modal-content bg-secondary">
                  ...
                  <form action="/user_mjoin_delete/{{ $mjoin->id }}" method="POST">
                    @csrf
