                ...
                @if(!$shops->isEmpty())
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          <a href="/user_cms_mjoin_edit_{{ $shop->id }}"><button class="btn btn-secondary btn-sm">編輯</button></a>
                          @if($shop->status!='del')
                            <button class="btn btn-danger btn-sm" href="#" data-toggle="modal" data-target="#modal-secondary{{ $shop->id }}">刪除</button>
                          @else
                            <a href="/user_mjoin_delete_back_{{ $shop->id }}"><button class="btn btn-secondary btn-sm">重新貼文</button></a>
                          @endif
                        </td>
                      </tr>
                      @if($mjoin->status!='del')
                      <div class="modal fade" id="modal-secondary{{ $shop->id }}">
                        <div class="modal-dialog">
                          <div class="modal-content bg-secondary">
                            ...
                            <form action="/user_mjoin_delete_{{ $shop->id }}" method="POST">
                              @csrf
                            <div class="modal-body">
                              <textarea class="form-control" rows="3" placeholder="請輸入被刪除的原因..." required name="msg"></textarea>
                            </div>
