                ...
                @if(!$mjoins->isEmpty())
                    ...
                    <tr>
                        ...
                        <td class="project-actions text-right">
                            <a class="btn btn-primary btn-sm" href="/user_mjoin_solo_{{ $mjoin->id }}">
                                <i class="fas fa-folder">
                                </i>
                                查看
                            </a>
                            <a class="btn btn-info btn-sm" href="/user_cms_mjoin_edit_{{ $mjoin->id }}">
                                <i class="fas fa-pencil-alt">
                                </i>
                                編輯
                            </a>
                            @ㄑㄛ
                            <a class="btn btn-danger btn-sm" href="/user_mjoin_delete_{{ $mjoin->id }}">
            ...
            <tbody>
              @if(!$shops->isEmpty())
                  ...
                  <tr>
                      ...
                      <td class="project-actions text-right">
                          <a class="btn btn-primary btn-sm" href="/user_shop_solo_{{ $shop->id }}">
                              <i class="fas fa-folder">
                              </i>
                              查看
                          </a>
                          <a class="btn btn-info btn-sm" href="/user_cms_shop_edit_{{ $shop->id }}">
                              <i class="fas fa-pencil-alt">
                              </i>
                              編輯
                          </a>
                          @if($shop->status != 'del')
                          <a class="btn btn-danger btn-sm" href="{{ route('user_shop_delete') }}?shopId={{ $shop->id }}">
                              <i class="fas fa-trash">
                              </i>
                              強制停止
                          </a>
                          @else
                          <a class="btn btn-danger btn-sm" href="/user_shop_delete_back_{{ $shop->id }}">
                            <i class="fas fa-trash">
                            </i>
                            恢復召募
                            </a>
