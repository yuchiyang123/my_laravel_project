        ...
        <div class="row">
            <div class="col-sm-6"><label>用戶頭貼</label>
                <div class="form-group">
                  @php
                    $profile_image_url = 'data:' . $user->profile_image_type . ';base64,' . base64_encode($user->profile_image);
                  @endphp
                  @if($profile_image_url.isEmpty())
                    <img src="{{asset('image/head.png')}}" alt="User Image" class="img-circle" style="width: 150px; height: 150px;">
                    @else
                    <img src="{{ $profile_image_url }}" alt="User Image" class="img-circle" style="width: 150px; height: 150px;"> 
                  @endif
