        ...
        <div class="row">
          ...
          <div class="col-sm-4">
            ...
            <div class="form-group">
             <label>是否公開年紀</label>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="age_private" value="public">
                <label class="form-check-label">年紀公開</label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="age_private" value="private" checked>
          ...
          <div class="col-sm-4">
            ...
            <div class="form-group">
             <label>是否公開性別</label>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="sex_private" value="public">
                <label class="form-check-label">性別公開</label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="sex_private" value="private" checked>
