                                ...
                                @foreach($joiners as $joinerCollection)
                                    @foreach($joinerCollection as $joiner)
                                        @if($joiner->article_id == $mjoin->id)
                                            @php
                                                $user = 'select * from user where id = ' . $joiner->user_id;
                                        
                                            @endphp
                                            <li class="list-inline-item">
                                                <a href="/user-profile/index/d/{{ $user }}"><img alt="Avatar" class="table-avatar" src="{{ $joiner->profile_image_url }}"></a>
                                            </li>
                                        @endif
                                    @endforeach
                                @endforeach
                          ...
                          <ul class="list-inline">
                              ...
                              @foreach($shop_joiners as $joinerCollection)
                                  @foreach($joinerCollection as $joiner)
                                      @if($joiner->article_id == $mjoin->id)
                                          <li class="list-inline-item">
                                            <a href="/user-profile/index/d/{{ $joiner->id }}"><img alt="Avatar" class="table-avatar" src="{{ $joiner->profile_image_url }}"></a>
                                          </li>
                                      @endif
                                  @endforeach
                              @endforeach
