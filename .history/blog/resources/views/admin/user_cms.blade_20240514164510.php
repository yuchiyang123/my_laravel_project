            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  @if($mjoin->status!='del')
                    <a href=""><button class="btn btn-danger btn-sm" href="#" data-toggle="modal" data-target="#modal-secondary">刪除</button></a>
                  @else
                    <a href=""><button class="btn btn-danger btn-sm" href="#" data-toggle="modal" data-target="#modal-secondary">重新貼文</button></a>
                  @endif
                </td>
              </tr>
