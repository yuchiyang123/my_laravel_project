      ...
      <form action="" method="post" enctype="multipart/form-data">
          ...
          <div class="col-sm">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" name="self_introduction" rows="3" placeholder=""
                @if($user_p != null) value="{{ $user_p->self_introduction }}" 
                            @else value="" placeholder="請輸入自我介紹" 
                            @endif>@if($user_p != null) {{ $user_p->self_introduction }}@else @endif
              </textarea>
            </div>
          </div>
        </div>
        <div class="row">
            <div class="col-sm-6">
              ...
              <div class="form-group">
                <label>社群連結1</label>
                <input type="text" class="form-control" name="social_links" pattern="https?://.+" @if($user_p->social_links!= null) value="{{ $user_p->social_links }}" @endif>
              </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    <label>社群連結2</label>
                    <input type="text" class="form-control" name="social_links2" pattern="https?://.+" @if($user_p->social_links2!= null) value="{{ $user_p->social_links2 }}" @endif>
                  </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-6">
              ...
              <div class="form-group">
                <label>社群連結3</label>
                <input type="text" class="form-control" name="social_links3" pattern="https?://.+" @if($user_p->social_links3!= null) value="{{ $user_p->social_links3 }}" @endif>
              </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    <label>社群連結4</label>
                    <input type="text" class="form-control" name="social_links4" pattern="https?://.+" @if($user_p->social_links4!= null) value="{{ $user_p->social_links4 }}" @endif>
                  </div>
            </div>
        </div>
        <!-- input states -->
        ...
        <div class="row">
          ...
          <div class="col-sm-4">
            ...
            <div class="form-group">
             <label>是否公開年紀</label>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="age_private" value="1" @if($user_p_public->user_age_public == 1) checked @endif>
                <label class="form-check-label">年紀公開</label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="age_private" value="0" @if($user_p_public->user_age_public == 0) checked @endif>
          ...
          <div class="col-sm-4">
            ...
            <div class="form-group">
             <label>是否公開性別</label>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="sex_private" value="1" @if($user_p_public->user_sex_public == 1) checked @endif>
                <label class="form-check-label">性別公開</label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="sex_private" value="0" @if($user_p_public->user_sex_public == 0) checked @endif>
