        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/user_auth" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>使用者管理</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/user_cms" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>CMS管理</p>
                </a>
              </li>
            ...
            <tr>
              ...
              <td>
                ...
                <div class="dropdown-menu">
                    ...
                    @else
                      <button class="dropdown-item" href="/user_resume/{{ $user->id }}" data-toggle="modal" data-target="#modal-secondary">用戶解除停權</button>
                    @endif
                </div>
              </td>
              <td>{{ $user->state }}</td>
