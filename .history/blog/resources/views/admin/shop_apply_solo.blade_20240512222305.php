    ...
    <div class="card card-warning">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <form action="{{ route('admin.shop_apply_pass', $shop_apply->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <button class="btn btn-danger" href="#" data-toggle="modal" data-target="#modal-secondary">拒絕</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade" id="modal-secondary">
            <div class="modal-dialog">
              <div class="modal-content bg-secondary">
                ...
                <form action="{{ route('admin.shop_apply_reject', $shop_apply->id) }}" method="POST">
                  @csrf
