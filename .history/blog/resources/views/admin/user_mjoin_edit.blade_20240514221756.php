...
<form id="postForm" action="{{ route('user_cms_mjoin_edit_submit', $mjoinedits->id) }}" method="POST">
    @csrf
    <div class="cut">
        <div class="grid-item">
            <div class="limt">
                <div class="mb-3">
                    <label class="post-title-label fw-bolder fs-2">揪團編輯</label>
                </div>
                ...
                <div class="LeaveMessageInput ">
                    <textarea name="editor" id="editor" placeholder="" style="background-color: black; color: white; border: none; width: 100%; height: 100%;">{!! $mjoinedits->description !!}</textarea> <!-- CKEditor 编辑器 -->
                </div>
                <div class="mb-3 pt-3">
                    <input type="submit" id="submitBtn" class="btn btn-primary" value="編輯" />
                </div>
            </div>
        </div>
    </div>
        ...
        class MyUploadAdapter {
            ...
            ClassicEditor
                .create(editorElement, {
                    ...
                    // Font color feature configuration.
		            fontBackgroundColor: 'Black' // Font color feature configuration.
