                ...
                @if(!$artworks->isEmpty())
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          <a href="/user_cms_shop_edit_{{ $artwork->id }}"><button class="btn btn-secondary btn-sm">編輯</button></a>
                          @if($shop->status!='del')
                            <button class="btn btn-danger btn-sm" href="#" data-toggle="modal" data-target="#modal-secondary_artwrok{{ $artwork->id }}">刪除</button>
                          @else
                            <a href="/user_shop_delete_back_{{ $artwork->id }}"><button class="btn btn-secondary btn-sm">重新貼文</button></a>
                          @endif
                        </td>
                      </tr>
                      @if($artwork->status!='del')
                      <div class="modal fade" id="modal-secondary_shop{{ $artwork->id }}">
                        <div class="modal-dialog">
                          <div class="modal-content bg-secondary">
                            <div class="modal-header">
                              <h4 class="modal-title">打工貼文刪除</h4>
                            ...
                            <form action="/user_shop_delete_{{ $artwork->id }}" method="POST">
                              @csrf
                            <div class="modal-body">
                              <textarea class="form-control" rows="3" placeholder="請輸入被刪除的原因..." required name="msg"></textarea>
                            </div>
