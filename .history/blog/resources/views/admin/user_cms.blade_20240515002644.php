                ...
                @if(!$shops->isEmpty())
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          @else
                            <a href="/user_shop_delete_back_{{ $shop->id }}"><button class="btn btn-secondary btn-sm">重新貼文</button></a>
                          @endif
                        </td>
                      </tr>
                      @if($shop->status!='del')
                      <div class="modal fade" id="modal-secondary_shop{{ $shop->id }}">
                        <div class="modal-dialog">
                          <div class="modal-content bg-secondary">
                            <div class="modal-header">
                              <h4 class="modal-title">打工貼文刪除</h4>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
            ...
            <tbody>
                @if(!$artworks->isEmpty())
                    ...
                    <tr>
                        ...
                        <td>
                          <a href="/user_artwork_solo_{{ $artwork->id }}"><button class="btn btn-primary btn-sm">詳細</button></a>
                          <a href="/user_cms_artwork_edit_{{ $artwork->id }}"><button class="btn btn-secondary btn-sm">編輯</button></a>
                          @if($artwork->status!='del')
                            <button class="btn btn-danger btn-sm" href="#" data-toggle="modal" data-target="#modal-secondary_artwork{{ $artwork->id }}">刪除</button>
                          @else
                            <a href="/user_artwork_delete_back_{{ $artwork->id }}"><button class="btn btn-secondary btn-sm">重新貼文</button></a>
                          @endif
                        </td>
                      </tr>
                      @if($artwork->status!='del')
                      <div class="modal fade" id="modal-secondary_artwork{{ $artwork->id }}">
                        <div class="modal-dialog">
                          <div class="modal-content bg-secondary">
                            <div class="modal-header">
                              <h4 class="modal-title">打工貼文刪除</h4>
                            ...
                            <form action="/user_artwork_delete_{{ $artwork->id }}" method="POST">
                              @csrf
                            <div class="modal-body">
                              <textarea class="form-control" rows="3" placeholder="請輸入被刪除的原因..." required name="msg"></textarea>
                            </div>
