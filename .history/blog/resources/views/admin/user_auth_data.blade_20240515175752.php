            ...
            <div class="col-sm"><label>用戶頭貼</label>
                ...
                <form action="{{ route('user_auth_data_submit', $user->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group" >
                                <label  for="timePicker">生日:</label>
                                <input type="time" id="timePicker" name="age" class="form-control datepicker" placeholder="{{ $user->age }}" required value="{{ $user->age }}">
                            </div>
                            </div>
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="@if($user->permissions == 3)使用者@elseif($user->permissions ==2)店家@else 管理員 @endif" disabled>
                  @if(@if($user->permissions != 1))
                  <select class="form-control" name="permissions">
                    <option value="3" @if(@if($user->permissions == 3)) selected @endif>使用者</option>
                    <option value="2" @if(@if($user->permissions == 2)) selected @endif>店家</option>
                  </select>
                  @else
                  <input type="text" class="form-control" placeholder="@if($user->permissions == 3)使用者@elseif($user->permissions ==2)店家@else 管理員 @endif" disabled>
                  @endif
