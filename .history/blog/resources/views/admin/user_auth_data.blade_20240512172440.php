        ...
        <div class="row">
          ...
          <div class="col-sm-4">
            ...
            <div class="form-group">
             <label>是否公開年紀</label>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="age_private" value="1" @if($user_p_p->user_age_public == 1) checked @endif>
                <label class="form-check-label">年紀公開</label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="age_private" value="0" @if($user_p_p->user_age_public == 0) checked @endif>
