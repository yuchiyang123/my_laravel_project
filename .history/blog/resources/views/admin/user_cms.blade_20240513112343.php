          ...
          <table class="table table-head-fixed text-nowrap">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <a href="/user_mjoin_solo_{{ $mjoin->id }}"><button class="btn btn-primary btn-sm">詳細</button></a></td>
                  <a href="/user_mjoin_solo_{{ $mjoin->id }}"><button class="btn btn-secondary btn-sm">編輯</button></a>
                  <a href="/user_mjoin_solo_{{ $mjoin->id }}"><button class="btn btn-danger btn-sm">刪除</button></a>
