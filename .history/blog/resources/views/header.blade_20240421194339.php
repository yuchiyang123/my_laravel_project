            ...
            <div class="headeractionmargin">
                <div class="dropdown">
                    <a class="" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false" style="width: 50px; height: 50px; margin: auto;">
                        <span class="position-relative" onclick="notifyMe()">通</span>
                    ...
                    <ul class="dropdown-menu mt-2 dropdown-menu-end scrolling-window" aria-labelledby="dropdownMenuLink">
                        <label class="dropdown-header fw-bold fs-5" id="join_normalnotify">申請通知</label>
                      <li><a class="dropdown-item" href="#" >
                        <img src="https://github.com/mdo.png" alt="mdo" width="50" height="50" class="rounded-circle">
                            <span class="fw-bold">有人申請你的揪團，請立刻查看！</span>
                        </a></li>
                        <label class="dropdown-header fw-bold fs-5"id="normalnotify">一般通知</label>
                        <li><a class="dropdown-item" href="#" >
                            <img src="https://github.com/mdo.png" alt="mdo" width="50" height="50" class="rounded-circle">
                        </a></li>
                    </ul>
