            ...
            <div class="headeractionmargin">
                <div class="dropdown">
                    <a class="" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false" style="width: 50px; height: 50px; margin: auto;">
                        <span class="position-relative scrolling-window" onclick="notifyMe()">通</span>
                    ...
                    <ul class="dropdown-menu mt-2 dropdown-menu-end" aria-labelledby="dropdownMenuLink">
                        <label class="dropdown-header fw-bold fs-5">申請通知</label>
                      <li><a class="dropdown-item" href="#" id="join_normalnotify">
                        ...
                        <li><a class="dropdown-item" href="#" id="normalnotify">
                            <img src="https://github.com/mdo.png" alt="mdo" width="50" height="50" class="rounded-circle">
                        </a></li>
                    </ul>
                  </div>
