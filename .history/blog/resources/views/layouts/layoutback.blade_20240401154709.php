...
<script>
    flatpickr(".datepicker", {
        ...
        onClose: function(selectedDates, dateStr, instance) {
            ...
            document.getElementById('postForm').innerHTML += '<input type="hidden" name="start_date" value="' + startFormatted + '">';
                document.getElementById('postForm').innerHTML += '<input type="hidden" name="end_date" value="' + endFormatted + '">';
            }
        }
        });
