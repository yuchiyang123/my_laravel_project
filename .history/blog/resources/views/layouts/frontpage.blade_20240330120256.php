                            ...
                            <div class="grid-item">
                                <div class="limt">
                                    ...
                                    <p class="main">
                                        ...
                                        <div class="trigger">
                                            @yield("PostShowAll")<!--a href="#">查看完整内容</a-->
                                        </div>
                                    </p>
                                    <div class="container">
                                        <div class="respond">
                                        ...
                                        <div class="message">
                                            <div>
                                                @yield("PostMessageHmany")<!--a href="#">8則留言</a-->
                                            </div>
                                        </div>
                                    </div>
                                    <div class="line">
                                    ...
                                    <div class="SeeAllMessage">
                                        @yield("PostMessageShowAll")<!--a href="#">查看全部留言</a-->
                                    </div>
                                    <div class="LeaveMessage">
                                        <div><a href="#"></a></div>
                                        <div>
                                            <div class="LeaveMessageimgdiv">
                                                @yield("LeaveMessageUsernameIMG")
                                            ...
                                            <div class="LeaveMessageall">
                                                ...
                                                <div class="LeaveMessageMain">
                                                    @yield("LeaveMessageOutside")
                                                </div>
                                                <div class="LeaveMessageAction">
                                                    @yield("LeaveMessageOutsideAction")
