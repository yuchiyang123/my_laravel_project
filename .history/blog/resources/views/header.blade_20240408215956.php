...
.headerdiv{
    display: grid;
    grid-template-columns: 170px auto repeat(4, 100px) 35px 50px auto 170px;
...
<header class="header">
    <div >
        <div class="headerdiv">
            ...
            <div class="ui small action input pt-3" style="height: 45px; width:150px; font-size: 16px; ">
            <input type="text" placeholder="Search...">
            <select class="ui compact selection form-select" style="font-size: 13px;">
