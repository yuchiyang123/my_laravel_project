...
<header class="header">
    <div >
        <div class="headerdiv">
            ...
            <div ></div>
            <div >
                <button id="notificationBtn" class="dropbtn"><img src="avatar.jpg" alt="User Avatar" class="avatar"></button>
                <div id="notificationPanel" class="dropdown-content">
                    <div class="notification-header d-flex justify-content-start">申請通知</div>
                    <a href="#">有人申請你的揪團</a>
                    <a href="#">有人申請你的打工團隊</a>
                    <div class="notification-header d-flex justify-content-start">一般通知</div>
                    <a href="#">有人按讚你的貼文</a>  
                </div>
            </div>
