...
<script type='txt/jsx' src="{{ asset('js/message_reply2.js') }}"></script>
            ...
            <div class="limt">
                ...
                <div class="ShowAllMessage">
                    <script>
                        ...
                        ReactDOM.render(React.createElement(ShowReply, { mjoinId: "{{ $mjoin->id }}" }), document.getElementById('showAllMessage_{{ $mjoin->id }}'));
