    ...
    <div class="cut">
        <div class="grid-item">
            <div class="limt">
                ...
                @endif
                <div class="row mb-3">
                    <div class="col-md-6 col-lg-4"><strong>店名:</strong> {{ $shops->shop_name }}</div>
                    <div class="col-md-6 col-lg-4"><strong>招募期間:</strong> {{ $shops->recruitment_period }}</div>
                    <div class="col-md-6 col-lg-4"><strong>縣市:</strong> {{ $shops->selectwhere }}</div>
                    <div class="col-md-6 col-lg-4"><strong>地址:</strong> {{ $shops->location }}</div>
                    <div class="col-md-6 col-lg-4"><strong>性別:</strong> {{ $shops->sex }}</div>
                    <div class="col-md-6 col-lg-4"><strong>工作經驗:</strong> {{ $shops->conditions_exp }}</div>
                    <div class="col-md-6 col-lg-4"><strong>每日工時:</strong> {{ $shops->work_hours }}</div>
                    <div class="col-md-6 col-lg-4"><strong>需要技能:</strong> {{ $shops->driver_license_requirements }}</div>
                    <div class="col-md-6 col-lg-4"><strong>提供:</strong> {{ $shops->benefits }}</div>
                    <div class="col-md-6 col-lg-4"><strong>語言能力:</strong> {{ $shops->language }}</div>
                </div>
