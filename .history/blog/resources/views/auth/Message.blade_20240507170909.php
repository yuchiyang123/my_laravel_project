            ...
            <div class="UserMassageBox" >
                <a href="/message-view-show/t/{{ $message->receiver_id }}" >
                    <div id= "message_container">
                        <div class="d-flex flex-row align-items-center" id="message_show_d{{ $message->receiver_id }}" data-receiver-id="{{ $message->receiver_id }}">>
...
$(document).ready(function() {
    var receiverId = $('#message_container').data('receiver-id');
