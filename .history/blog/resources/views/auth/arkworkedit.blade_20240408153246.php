        ...
        <div class="grid-item">
            <div class="limt">
                ...
                <div class="mb-3 text-start">
                    ...
                    <input class="form-control" type="text" name="title" placeholder="" aria-label="title">{{ $userarkworkedit->title }}
                </div>
                <div class="mb-3 text-start">
                ...
                <div class="LeaveMessageInput ">
                    <textarea name="editor" id="editor" placeholder="">{!! $userarkworkedit->main !! }</textarea> <!-- CKEditor 编辑器 -->
                </div>
                <div class="mb-3 pt-3">
