                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-6">
                                            ...
                                            <p class="form-control">{{ $shops->location }}</p>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">性別:</label>
                                            <p class="form-control">{{ $shops->sex }}</p>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-md-6">
                                            <label class="form-label">工作經驗:</label>
                                            <p class="form-control">{{ $shops->conditions_exp }}</p>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">每日工時:</label>
                                            <p class="form-control">{{ $shops->work_hours }}</p>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-md-6">
                                            <label class="form-label">需要技能:</label>
                                            <p class="form-control">{{ $shops->driver_license_requirements }}</p>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">提供:</label>
                                            <p class="form-control">{{ $shops->benefits }}</p>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-md-6">
                                            <label class="form-label">語言能力:</label>
                                            <p class="form-control">{{ $shops->language }}</p>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">工作內容:</label>
                                            <p class="form-control">{{ $shops->job_description }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
