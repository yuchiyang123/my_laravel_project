...
<div class="">
    ...
    <div class="UserMassageBox" >
        ...
        @foreach ($messages as $message)
            @foreach ($user_idd as $user_iddd)
                @if($user_idd==$message->user_id || $receiver_idd==$message->$receiver_id
                ||$user_idd== $message->receiver_id || $receiver_idd==$message->user_id)
                    @continue 
                @endif
            @endforeach
        
        @php
            $user_idd[] =  $message->user_id;
            $receiver_idd[] =  $message->receiver_id;
        @endphp
