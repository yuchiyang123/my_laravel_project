                ...
                <div class="image-container">
                    <div class="d-block mb-3 text-start text-break">
                        ...
                        preg_match_all('/<img[^>]+src="([^">]+)"/', $mjoin->description, $matches); // 提取第一个图片
                            ...
                            @endphp
                            @if(strlen($text) > 150)
                            <p>{!! $text !!}<a href="#" class="link-secondary fw-blod" id="{{ $mjoin->id }}" data-mjoin-id="{{ $mjoin->id }}" onclick="showPopup({{ $mjoin->id }})">繼續閱讀</a></p>
                            ...
                            <div id="carouselExampleControlsNoTouching" class="carousel carousel-dark slide" data-bs-interval="false">
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item active">
                                        <img src="{{ $allimgs }}" class=" d-flex justify-content-center" alt="Image">
                                    </div>
                                    @php
                                    $imgcount +=1;
                                    @endphp
                                    ...
                                    <div class="carousel-item">
                                        <img src="{{ $allimgs }}" class="d-block d-flex justify-content-center" alt="Image">
                                    </div>
                                    @php
                                    $imgcount +=1;
                                    @endphp
