...
<label class="post-title-label3 fw-bolder">詳細內容:</label>
<div class="LeaveMessageInput border-top pt-2 fw-bold">
                                                    <div class="LeaveMessageInputrpAname"><img  neae="LeaveMessageUsernameIMGreply" src="img/2-1.png" class="LeaveMessageUsernameIMG LeaveMessageUsernameIMGreply"><div name="LeaveMessageUsernamereply">your name </div><!-- 图像 --></div>
                                                <textarea neae="editor" id="editor" placeholder="留言"></textarea> <!-- CKEditor 编辑器 -->
                                            </div>
</div>
</div>
</div>
