        ...
        <div class="grid-item">
            <div class="limt">
                ...
                <div class="line">
                    ...
                    @if(session('user_name')!=null && 
                    \App\Models\Shop_join::where('article_id', $shop->id)->where('status','end,complete')->where('user_id', Auth::user()->id)->exists())
                    ...
                    @endif
                    @php $exists = \App\Models\Shop_join::where('article_id', $shop->id)->where('user_id', Auth::user()->id)->exists();  @endphp
                    @if(session('user_name')!=null && session('user_name')!=$shop->posted_by_u && !$exists)
