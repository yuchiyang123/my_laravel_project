            ...
            <div class="limt">
                ...
                <div class="mb-3 text-start">
                    ...
                    <div class="ui small basic icon buttons">
                        <button class="ui button" type="file" name="image" accept="image/*" onchange="showImage(this);">上傳圖片<i class="upload icon"></i></button>
                    </div>
                    <input class="ui button" type="file" name="image" accept="image/*" onchange="showImage(this);"><i class="upload icon"></i>
                <div>
                </div>
                <div class="mb-3 text-start">
