...
<div class="cut">
    <div class="grid-item">
        <div class="limt">
            ...
            <div class="main image-container d-block mb-3">
                {!! $mjoin->description !!}
            </div>
            <div class="trigger d-block mb-3">
                <a href="#" id="{{ $mjoin->id }}" data-mjoin-id="{{ $mjoin->id }}" onclick="showPopup({{ $mjoin->id }})">查看完整内容</a></div>
            </div>
            <div class="container">
                <div class="respond">
