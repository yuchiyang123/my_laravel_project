        ...
        <div class="grid-item">
            <div class="limt">
                ...
                <div class="mb-3 text-start ">
                    ...
                    <input type="text" id="timePicker" name="recruitment_period" class="form-control datepicker" placeholder="{{ $mjoinedits->time }}">
                    <input type="hidden" id="diffDay" value="{{ $mjoinedits->diffDay }}" name="diffDay">
                </div>
                <div class="mb-3 text-start">
                ...
                <div class="mb-3 text-start">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" value="中文" id="chineseCheckbox" name="languages[]" {{ $shopedits->languages && in_array('中文', $shopedits->languages) ? 'checked' : '' }}>
                        <label class="form-check-label" for="chineseCheckbox">中文</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" value="日文" id="japaneseCheckbox" name="languages[]" {{ $shopedits->languages && in_array('日文', $shopedits->languages) ? 'checked' : '' }}>
                        <label class="form-check-label" for="japaneseCheckbox">日文</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" value="韓文" id="koreanCheckbox" name="languages[]" {{ $shopedits->languages && in_array('韓文', $shopedits->languages) ? 'checked' : '' }}>
                        <label class="form-check-label" for="koreanCheckbox">韓文</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" value="英文" id="englishCheckbox" name="languages[]" {{ $shopedits->languages && in_array('英文', $shopedits->languages) ? 'checked' : '' }}>
                        <label class="form-check-label" for="englishCheckbox">英文</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" value="台語" id="taiwaneseCheckbox" name="languages[]" {{ $shopedits->languages && in_array('台語', $shopedits->languages) ? 'checked' : '' }}>
