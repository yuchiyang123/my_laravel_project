            ...
            <div class="limt">
                ...
                <div class="container">
                    <div class="respond">
                        ...
                        <a href="#">👍🏽</a>
                        <div>
                            <a href="#" onclick="sendClickGoodEvent({{ $mjoin->id }})" data-mjoin-count="{{ $mjoin->id }}">
                ...
                <div class="ShowAllMessage">
                    <script>
                        ...
                        function sendClickGoodEvent(mjoinId) {
                            mjoin_post_countgood(mjoinId);
                            window.Echo.channel('mjoin_post_' + mjoinId)
                                .broadcast('postGoodCountUpdated', { mjoinId: mjoinId });
                        }
