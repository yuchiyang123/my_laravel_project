        ...
        <div class="col-xl-4">
            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body text-center">
                    ...
                    <!-- 显示原始图片 -->
                    <?php $imageDataUri = 'data:image/png;base64,' . base64_encode($userdataedit->profileImage); ?>
                    <!-- 显示原始图片 -->
                    @if($userdataedit->profileImage != null)
                        <img id="original-image" alt="圖片" class="img-account-profile rounded-circle mb-2" 
                        src="{{ $userdataedit->profileImage }}">
                    @endif

                    @if($userdataedit->profileImage == null)
                    <img id="original-image" alt="圖片" class="img-account-profile rounded-circle mb-2" src="http://bootdey.com/img/Content/avatar/avatar1.png"  >
                    @endif
