...
<div class="condition">
    ...
    <form action="/search-mjoin" method="get" id="search_mjoin">
        ...
        <div class="condition-radio text-start">
            ...
            <select id="selectwhere" name="destination" required class="pb-1 form-select form-select-sm" aria-label=".form-select-sm example">
                    ...
                    @if($current_time < $end_date)
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                @if(Auth::user()->username==$mjoin->posted_by_u)
