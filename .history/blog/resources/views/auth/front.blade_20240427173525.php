...
<script type="module" src="https://unpkg.com/react@17/umd/react.production.min.js"></script>
<script type="module" src="https://unpkg.com/react-dom@17/umd/react-dom.production.min.js"></script>
<script src="{{ asset('js/message_reply2.js') }}"></script>
        ...
        <div class="grid-item">
            <div class="limt">
                ...
                <div class="ShowAllMessage">
                    <script>
                        ReactDOM.render(<ShowReply mjoinId="{{ $mjoin->id }}" />, document.getElementById('showAllMessage_{{ $mjoin->id }}'));
