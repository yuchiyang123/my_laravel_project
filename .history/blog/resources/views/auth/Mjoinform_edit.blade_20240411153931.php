        ...
        <div class="grid-item">
            <div class="limt">
                ...
                <div class="mb-3 text-start">
                    ...
                    <input type="text" id="timePicker" name="time" class="form-control datepicker" placeholder="{{ $mjoindeits->time }}" value="{{ $mjoindeits->time }}" required>
                    <input type="hidden" id="diffDay" name="diffDay" value="{{ $mjoindeits->diffDay }}" required>
                </div>
                ...
                <div class="mb-3 text-start ">
                    ...
                    <select id="budget" name="people" class="form-select form-select-sm" aria-label=".form-select-sm example">
                        ...
                        <option value="2~4">兩人~四人</option>
                        <option value="5~7">五人~七人</option>
                        <option value="8~10">八人~十人</option>
