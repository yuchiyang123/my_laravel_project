        ...
        <div class="col-xl-4">
            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body text-center">
                    ...
                    <img src="data:image/jpeg;base64,{{ base64_encode($userdataedit->profileImage) }}" alt="Profile Picture">

                    <!-- 显示原始图片 -->
                    <img id="original-image" class="img-account-profile rounded-circle mb-2" @if($userdataedit->profileImage) 
                    src="data:image/png;base64,{{ base64_encode($userdataedit->profileImage) }}" 
                    @else src="http://bootdey.com/img/Content/avatar/avatar1.png" @endif alt="Profile Picture">
