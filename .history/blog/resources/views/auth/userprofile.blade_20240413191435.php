                                        ...
                                        @if($username == session('user_name'))
                                            <div class="dropdown ms-2">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <div class="dropdown-divider"><a id="collect_{{ $userarkwork->id }}" class="dropdown-item" href="javascript:void(0);" data-mjoin-id="{{ $userarkwork->id }}" onclick="collect({{ $userarkwork->id }})">
                                                    收藏
                                                    </a></div>
