        ...
        <div class="col-xl-4">
            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body text-center">
                    ...
                    <!-- 显示原始图片 -->
                    <?php $imageDataUri =   base64_encode($userdataedit->profileImage); ?>
                    <!-- 显示原始图片 -->
                    @if($userdataedit->profileImage != null)
                    <img id="original-image" alt="圖片" class="img-account-profile rounded-circle mb-2" src="data:image/png;base64,">
                    ...
                    <!-- 模态框 -->
                    <div class="modal fade" id="crop-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                        ...
                        <div class="modal-body">
                            <div id="cropper-container"><img id="original-image-modal" class="img-fluid" src="" alt="" ></div>
                        </div>
                        <div class="modal-footer">
                        <input  id="upload-input-1" type="hidden" style="display:none;" name="image">   
