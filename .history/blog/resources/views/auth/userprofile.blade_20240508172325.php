            ...
            <div class="card-body pb-0">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-9">
                        <div class="ms-3">
                            <div>
                                <h4 class="card-title mb-2 fw-bold">自我介紹<a href="/message-view-show/{{$userrecord->username}}"><button type="submit" class="btn btn-primary btn-sm">聯絡我</button></a></h4>
...
@if(!is_null($userinfo) && $userinfo->favorite_articles_visibility == 'public' || !empty($userinfo->favorite_articles_visibilit))
        <div class="card">
            <div class="tab-content p-4">
                <div class="tab-pane active show" id="projects-tab" role="tabpanel">
                    <div class="d-flex align-items-center justify-content-between">
