            ...
            <div class="limt">
                ...
                <div class="mb-3 text-start">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" value="住宿" id="accommodation" name="expected_salary[]" checked required>
                ...
                <div class="mb-3 text-start">
                    <div class="mb-3 text-start">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" value="外向" id="personality_outgoing" name="personality[]" checked required>
                ...
                <div class="mb-3 text-start">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" value="有" id="driving_license_yes" name="driving_license" checked required>
