...
<div class="LeaveMessageInput flex-row">
    ...
    <div class="p-2">
        <textarea class="form-control" placeholder="留言" id="messageTextarea_123" name="messageTextarea_123" rows="1"></textarea>
    </div>
    <button type="submit" class="btn btn-primary" id="submitReply">留言</button>
</div>
