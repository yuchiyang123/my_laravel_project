...
<div class="condition">
    ...
    <form action="/search-mjoin" method="post" id="search_mjoin">
        @csrf
        <div class="condition-radio text-start">
            ...
            <div class="radio-group">
                <div class="form-check pb-1">
                    <input class="form-check-input" type="radio" name="date" value="4"><label class="form-check-label fw-bold">四天~六天(0)</label>
                </div>
            </div>
            <div class="radio-group">
                <div class="form-check pb-1">
                    <input class="form-check-input" type="radio" name="date" value="7"><label class="form-check-label fw-bold">七天~九天(0)</label>
                </div>
            </div>
            <div class="radio-group">
                <div class="form-check pb-1">
                    <input class="form-check-input" type="radio" name="date" value="10"><label class="form-check-label fw-bold">十天以上(0)</label>
                </div>
            </div>
        </div>
        ...
        <div>
            <div class="condition-radio text-start">
                ...
                <div class="radio-group">
                    <div class="form-check pb-1">
                        <input class="form-check-input" type="radio" name="NOpeople" value="2"><label class="form-check-label fw-bold">2~4人</label>
                    </div>
                </div>
                <div class="radio-group">
                    <div class="form-check pb-1">
                        <input class="form-check-input" type="radio" name="NOpeople" value="5"><label class="form-check-label fw-bold">5~7人</label>
                    </div>
                </div>
                <div class="radio-group">
                    <div class="form-check pb-1">
                        <input class="form-check-input" type="radio" name="NOpeople" value="8"><label class="form-check-label fw-bold">8~10人</label>
                    </div>
                </div>
                <div class="radio-group">
                    <div class="form-check pb-1">
                        <input class="form-check-input" type="radio" name="NOpeople" value="10"><label class="form-check-label fw-bold">10人以上</label>
                    </div>
                </div>
            </div>
        </div>
...
<script>
            ...
            $('#searchForm').submit(function(event){
                ...
                var NOpeople = $('input[name=NOpeople]:checked').val();
                var age = $('input[name=age]:checked').val();

                // 发送 AJAX 请求
                $.ajax({
                    type: 'GET',
                    url: '/search-mjoin', // 搜索路由
                    data: {
                        date: date,
                        sex: sex,
                        skill: skill,
                    ...
                    success: function(response){
                        $('.outside').html(response.htmlContent_search);
                        $('.outside').show();
                    },
                    error: function(xhr, status, error){
                        console.error(xhr.responseText);
