        ...
        <div class="card">
            <div class="tab-content p-4">
                <div class="tab-pane active show" id="projects-tab" role="tabpanel">
                    ...
                    <div class="row" id="all-projects">
                        @if(!empty($userCollections) || !empty($userCollections_mjoin))
                            @foreach([$userCollections, $userCollections_mjoin] as $collection)
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="align-self-end">
                                                        <span class="badge badge-soft-danger p-2 team-status">{{ $item->class }}</span>
                                                    </div>
                                                </div><!-- end d-flex -->
                                            </div><!-- end card-body -->
                                        </div><!-- end card -->
