                ...
                <div class="line">
                    ...
                    @php
                        if(Auth::check()){
                            ...
                            $userJoinMjoinStatus1 = \App\Models\User_join_mjoin::where('user_id', Auth::user()->id)
                                                                            ->where('article_id', $mjoin->id)->first();
                                                                            
                            $userPostMjoinStatus1 = \App\Models\UserPostMjoin::where('id', $mjoin->id)
                                                                            ->where('posted_by_u',Auth::user()->username)->first();
                    ...
                    @endphp
                    @if(Auth::check())
                        @if($user_post_mjoin_join && $end_date < $current_time && !$userMjoinScore)
                            @if($userJoinMjoinStatus1 || $userPostMjoinStatus1)
