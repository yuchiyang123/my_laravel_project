...
<div class="cut">
        <div class="grid-item">
            <div class="limt">
                ...
                <div class="mb-3 text-start">
                    <label class="post-title-label fw-bolder">聯絡方式:</label>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="music" name="preferences[]" value="音樂活動">
                        <label class="form-check-label" for="music">站內</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="music" name="preferences[]" value="音樂活動">
                        <label class="form-check-label" for="music">電話</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="music" name="preferences[]" value="音樂活動">
                        <label class="form-check-label" for="music">Email</label>
                    </div>
                </div>
                <div class="mb-3 text-start">
