            ...
            <div class="limt">
                ...
                <div class="mb-3 text-start">
                    ...
                    <select id="driver_license_requirements" name="driver_license_requirements" class="form-select form-select-sm" aria-label=".form-select-sm example">
                        <option value="不需要" @if($shopedits->sex == '不需要') selected @endif>不需要</option>
                        <option value="car" @if($shopedits->sex == 'car') selected @endif>開車</option>
                        <option value="motorcycle" @if($shopedits->sex == 'motorcycle') selected @endif>騎車</option>
                        <option value="both" @if($shopedits->sex == 'both') selected @endif>都需要</option>
                    </select>
                </div>
                <div class="mb-3 text-start ">
