            ...
            <div class="UserMassageBox">
                <a href="/message-view-show/t/{{ $message->receiver_id }}" >
                    <div id= "message_container">
                        <div class="d-flex flex-row align-items-center" id="message_show_d{{ $message->receiver_id }}" value="{{ $count }}">
...
<script>
    $(document).ready(function() {
        var count = @json($count); // 将 PHP 变量转换为 JavaScript 变量
        console.log(count);
    
        function setupWebSocket(count) {
            if (count >= 1) {
