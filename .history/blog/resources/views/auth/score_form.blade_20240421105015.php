...
<div style="text-align: center; ">
    ...
    <div class="score-container d-flex justify-content-start"><h3 class="fw-bolder">用戶名</h3></div>
<div class="feedback d-flex justify-content-center m-1 pt-5  border-top border-2" >
    <label class="angry">
