            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="mb-3">
                            <label class="small mb-1" for="inputEmailAddress">電話: 已經驗證了嗎?{{ $userdataedit->verify }}</label>
                        </div>
                        <div class="mb-3">
                            <label class="small mb-1" for="inputEmailAddress">
                                身分組:@if({{ $userdataedit->verify }} == 3)使用者@elseif({{ $userdataedit->verify }} == 2)店家@endif
                            </label>
                        </div>
                        <div class="mb-3">
