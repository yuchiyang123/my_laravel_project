    ...
    <div class="cut">
        <div class="grid-item">
            <div class="limt">
                ...
                <div class="post_condition fw-bolder border-bottom border-top pt-2 pb-2 mt-1 mb-1 d-flex flex-row bd-highlight text-break" style="font-size: 14px;top:-40px;position:relative;">
