            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="social_media_1" class="form-control form-control-sm" @if($userdataedit->social_links!= null) value="{{ $userdataedit->social_links->social_media_1 }}" @endif>
                            <input type="text" name="social_media_2" class="form-control form-control-sm">
                            <input type="text" name="social_media_3" class="form-control form-control-sm">
                            <input type="text" name="social_media_4" class="form-control form-control-sm">
                        </div>
