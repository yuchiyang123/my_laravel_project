                        ...
                        <div class="col-md-6" id="project-items-1">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        <a href="/arkwork_solo/solo/{{ $userCollections_mjoin->id }}"><h4 class="mb-1 font-size-17 team-title pt-1">{{ $userCollections_mjoin->title }}</h4></a>
                                        <p class="text-muted mb-0 team-description">
                                        {!! Str::limit(strip_tags($userCollections_mjoin->description, '<p><a><br><b><strong><i><em><ul><ol><li><blockquote><code>'), 75, '...') !!}
                                        </p>
                                    </div>
                                    <div class="d-flex">
                                        <div class="avatar-group float-start flex-grow-1 task-assigne">
