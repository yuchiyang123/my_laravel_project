        ...
        <div class="grid-item">
            <div class="limt">
                ...
                <div class="line">
                    ...
                    @endphp
                    @if(Auth::check())
                        @if($user_post_mjoin && $user_post_mjoin_join && $end_date < $current_time)
                    ...
                    @if( Auth::check()&&(!$userMjoinScore && $userJoinMjoinStatus == 'pass' )&&$end_date < $current_time)
...
<div class="overlay" id="overlay"></div>
    ...
    @section('mjoin_member')
        @if(Auth::check())
            @if($mjoin->posted_by_u != null )
            <label for="joinmjoin_usermember">你的團隊的隊員</label>
            <div class="list-group">
                
                <a href="/mjoin_solo/{{ $join_mjoin_you->id }}" class="list-group-item list-group-item-action">{{ $join_mjoin_you->title }}</a>
