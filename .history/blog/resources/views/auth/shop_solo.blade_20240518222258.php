                    ...
                    <div class="d-block mb-3 text-start text-break">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row">工作經驗</th>
                                    <td>{{ $shops->conditions_exp }}</td>
                                </tr>
                                <tr>
                                    <th scope="row">每日工時</th>
                                    <td>{{ $shops->work_hours }}</td>
                                </tr>
                                <tr>
                                    <th scope="row">需要技能</th>
                                    <td>{{ $shops->driver_license_requirements }}</td>
                                </tr>
                                <tr>
                                    <th scope="row">提供</th>
                                    <td>{{ $shops->benefits }}</td>
                                </tr>
                                <tr>
                                    <th scope="row">語言能力</th>
                                    <td>{{ $shops->language }}</td>
                                </tr>
                                <tr>
                                    <th scope="row">工作內容</th>
                                    <td>{{ $shops->job_description }}</td>
                                </tr>
                            </tbody>
                        </table>
