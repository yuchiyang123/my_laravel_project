...
<div style="text-align: center; ">
    ...
    @if(Auth::user()->username != $mjoin_author_1->posted_by_u)
        ...
        <div class="feedback d-flex justify-content-center m-1 " >
            <label class="angry">
                <input type="radio" value="1" name="feedback{{ $mjoin_author_1->posted_by_u }}" />
                <div>
                    <svg class="eye left">
                        <use xlink:href="#eye">
                    </svg>
            ...
            <label class="sad">
                <input type="radio" value="2" name="feedback{{ $mjoin_author_1->posted_by_u }}" />
                <div>
                    <svg class="eye left">
                        <use xlink:href="#eye">
                    </svg>
            ...
            <label class="ok">
                <input type="radio" value="3" name="feedback{{ $mjoin_author_1->posted_by_u }}" />
                <div></div>
            </label>
            <label class="good">
                <input type="radio" value="4" name="feedback{{ $mjoin_author_1->posted_by_u }}" checked />
                <div>
                    <svg class="eye left">
                        <use xlink:href="#eye">
                    </svg>
            ...
            <label class="happy">
                <input type="radio" value="5" name="feedback{{ $mjoin_author_1->posted_by_u }}" />
                <div>
                    <svg class="eye left">
                        <use xlink:href="#eye">
                    </svg>
        ...
        <div class="LeaveMessageInput flex-row border-bottom border-2">
            <div class="p-2">
                <textarea class="form-control" placeholder="詳細說明這旅程與他想處的經過" id="comments_123" name="comments_123" rows="3
                "></textarea>
            </div>
        </div>
        @endif
    ...
    @php
        $mjoin_author_1 = DB::table('user')->where('id', $join_member->mjoin_id)->first();
    @endphp
    <div class="score-container d-flex justify-content-start pt-2  border-top border-2"><h3 class="fw-bolder">夥伴:{{ $join_member-> }}</h3></div>
<div class="feedback d-flex justify-content-center m-1 " >
    <label class="angry">
