		...
		<div class="card vh-100 d-flex">
			<div class="row g-0">
				<div class="">
					...
					<div class="position-relative scrollable-window bg-light p-3" tabindex="0" style="max-height: 500px; overflow-y: auto;" data-bs-spy="scroll" id='position-relative_msg'>
