            ...
            <div class="limt">
                ...
                <div class="mb-3 text-start ">
                    ...
                    <select id="budget" name="people" class="form-select form-select-sm" aria-label=".form-select-sm example">
                        ...
                        <option value="當天來回">當天來回</option>
                        <option value="兩人">兩人</option>
                        <option value="三人">三人</option>
                        <option value="四人">四人</option>
                        <option value="五人">五人</option>
                        <option value="六人">六人</option>
                        <option value="七人">七人</option>
                        <option value="八人">八人</option>
                        <option value="九人">九人</option>
                        <option value="九人以上">九人以上</option>
                    </select>
                </div>
                <div class="mb-3 text-start">
