                                    ...
                                    <div class="d-flex mb-3">
                                        ...
                                        <div class="dropdown ms-2">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item" href="{{ $userarkwork->id }}" data-bs-target=".bs-example-new-project">編輯</a>
                                                
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item delete-item"  data-id="project-items-1" href="{{ $userarkwork->id }}">刪除</a>
                                            </div>
                                        </div>
                                        @endif
                                    </div>
