        ...
        <div class="grid-item">
            <div class="limt">
                ...
                <div class="mb-3 text-start ">
                    ...
                    <input class="form-control" name="business_registration_number" type="{{ $shop->uniform_numbers }}" value="Readonly input here..." aria-label="readonly input example" readonly>
                </div>
                <div class="mb-3 text-start">
                ...
                <div class="mb-3 text-start">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" value="日文" id="japaneseCheckbox" name="languages[]">
                        <label class="form-check-label" for="japaneseCheckbox">日文</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" value="韓文" id="koreanCheckbox" name="languages[]">
