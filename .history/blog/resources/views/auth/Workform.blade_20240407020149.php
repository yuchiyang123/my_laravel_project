            ...
            <div class="limt">
                ...
                <div class="mb-3 text-start">
                    ...
                    <select id="work_hours" name="work_hours" required class="form-select form-select-sm" aria-label=".form-select-sm example">
                        ...
                        <option value="2~3">1~2小時</option>
                        <option value="3~4">3~4小時</option>
                        <option value="4~5">1~2小時</option>
                        <option value="5~6">5~6小時</option>
                        <option value="6~7">1~2小時</option>
                        <option value="7~8">7~8小時</option>
                        <option value="8~9">7~8小時</option>
                    </select>
                </div>
                <div class="mb-3 text-start">
                    <div class="form-check form-check-inline">
                ...
                <div class="mb-3 text-start">
                    <label class="post-title-label2 fw-bolder">店家提供:</label>
                ...
                <div class="LeaveMessageInput ">
                    <label class="post-title-label2 fw-bolder">店家介紹:</label>
