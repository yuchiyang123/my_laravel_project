            ...
            <div class="limt">
                ...
                <div class="mb-3 text-start">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" value="無過敏" id="radio_none_" name="preferences[]">
...
<script>
    ...
    // 获取单选按钮和复选框
        ...
        const checkboxes = document.querySelectorAll('.form-check-inline input[name="foodallergy[]"]');
