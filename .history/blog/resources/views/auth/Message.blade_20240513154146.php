...
<div class="">
    ...
    @foreach ($messages as $message)
        @php
            ...
            if (in_array($message->user_id, $processed_user_ids) || in_array($message->receiver_id, $processed_receiver_ids)
            in_array($message->receiver_id, $processed_user_ids) || in_array($message->user_id, $processed_user_ids)) {
                continue;
            }
