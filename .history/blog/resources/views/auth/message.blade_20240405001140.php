        ...
        <div class="UserMassageBox">
            <a href="#">
                <div class="d-flex flex-row align-items-center">
                    <img src="{{ asset('image/head.png') }}" style="width: 90px;" class="user_img_message" id="{{ $message->senderu }} " onclick="messageall_({{ $message->senderu }})">
                    <div class="">
...
@endsection
<script>
    function messageall(userid) {
    .ajax({
        url: "/message-view-show/d/" + userid,
        type: "GET",
        success: function(response) {
            // 在彈出的視窗中顯示留言
            $('#showAllMessage_' + userid).html(response.htmlContent);
            $('#showAllMessage_' + userid).show();
        },
