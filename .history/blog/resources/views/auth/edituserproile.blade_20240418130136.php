                        ...
                        <div class="row gx-3 mb-3">
                            <div class="col-md-6">
                                <div class="mb-3 text-start">
                                    ...
                                    <input type="text" id="timePicker" name="time" class="form-control datepicker" placeholder="" value="" required>
                                    <input type="hidden" id="diffDay" name="diffDay" value="" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <br>
