...
@endif
<form method="POST" action="/join_mjoin/submit/{{ $User_mjoin_infor->id }}">
    @csrf
<div class="cut">
        <div class="grid-item">
            <div class="limt">
                ...
                <div class="mb-3 text-start">
                    ...
                    @if($User_infor->age ==  '')
                        <input type="text" id="timePicker" name="age" class="form-control datepicker" placeholder="請選擇時間">
                    @else
                        <input type="text" id="timePicker" name="age" class="form-control datepicker" value="{{ $User_infor->age }}">
                    @endif
                ...
                <div class="mb-3 text-start">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" value="中文" id="chineseCheckbox" name="languages[]" checked>
                        <label class="form-check-label" for="chineseCheckbox">中文</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" value="英文" id="englishCheckbox" name="languages[]">
                        <label class="form-check-label" for="englishCheckbox">英文</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" value="台語" id="taiwaneseCheckbox" name="languages[]">
                ...
                <div class="mb-3 text-start">
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="contact_method_phone">電話({{ $User_infor->phone }})</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="contact_method_email" name="contact_method[]" value="Email">
                        <label class="form-check-label" for="contact_method_email">Email({{ $User_infor->email }})</label>
                    </div>
                </div>
