...
<form action="{{ route('editProfilesubmit') }}" method="get" enctype="multipart/form-data">
    @csrf
        ...
        <div class="col-xl-4">
            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body text-center">
                    ...
                    <!-- 上传按钮 -->
                    <input type="file" id="upload-input" accept="image/*" style="display:none;" name="image">
...
*/
  ...
  // 将裁剪后的图片数据放回到文件上传字段中
  var blob = dataURItoBlob(croppedUrl);
  ...
  // 替换原始的文件上传字段
  $('#upload-input').hide().after(newInput);
