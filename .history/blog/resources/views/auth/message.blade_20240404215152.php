        ...
        <div class="UserMassageBox">
            <a href="#">
                <div class="d-flex flex-row align-items-center">
                    <img src="{{ asset('image/head.png') }}" style="width: 90px;" class="user_img_message" id="{{ $message->receiveru }}">
                    <div class="">
                        <div class="d-flex align-items-center fw-bold UserMassageBoxName">
                            <span class="">{{ $message->receiveru }}</span>
                        </div>
                        <div class="d-flex align-items-center UserMassageBoxMessage">
                            <span class="">{{ $messag->$main }} </span><span class="">。10小時前</span>
                        </div>
                    </div>
