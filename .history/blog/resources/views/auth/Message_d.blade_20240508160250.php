		...
		<div class="card vh-100 d-flex">
			<div class="row g-0">
				<div class="">
                    ...
                    <div class="position-absolute bottom-50 start-50 translate-middle-x" style="bottom: 0; left: 0; width: 100%; background-color: #ffffff; padding: 10px; box-sizing: border-box;">
                        <div style="">
                            <input type="text" id="message_submit" style="">
