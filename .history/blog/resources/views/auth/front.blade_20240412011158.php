...
<script src="https://cdnjs.cloudflare.com/ajax/libs/echo/1.12.4/echo.min.js"></script>
        ...
        $(document).ready(function() {
            ...
            links.each(function() {
                ...
                link.click(function(event) {
                    ...
                    window.Echo.channel('mjoin_post_' + mjoinId)
                        .listen('.postGoodCountUpdated', (event) => {
                            // 更新 HTML 元素
                            $('.goodcount_' + mjoinId).html(event.count);
                            $('.goodcount_' + mjoinId).show();
                        });
                });
