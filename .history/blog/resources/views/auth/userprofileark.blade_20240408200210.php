                        ...
                        <div class="col-md-6" id="project-items-1">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        ...
                                        <div class="dropdown ms-2">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <a class="dropdown-item delete-item" onclick="deleteProjects('project-items-1')" data-id="project-items-1" href="{{ $userarkwork->id }}">刪除</a>
                                            </div>
                                        </div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        <a href="{{ route('arkwork_edit_post', ['ark_id' => $userarkwork->id]) }}"><h4 class="mb-1 font-size-17 team-title pt-1">{{ $userarkwork->title }}</h4></a>
