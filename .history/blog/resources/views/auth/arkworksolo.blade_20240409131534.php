        ...
        <div class="limt">
            ...
            <div class="line">
                <div class="inner-grid">
                    <form id="like-form" action="{{ route('posts.like', ['userarkworksolo' => $userarkworksolo->id, 'artwork' => $artwork->id]) }}" method="POST">
                        @csrf
                        <button type="submit" class="btn btn-primary like-button" data-reply-id="{{ $userarkworksolo->id }}">Like</button>
                    </form>
                </div>
                <div class="inner-grid">
                    <a href="#"></a>
...
<script>
    document.querySelectorAll('.like-button').forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            // 訂閱事件頻道
            window.Echo.channel('post.' + replyId)
