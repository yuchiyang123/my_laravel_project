			...
			<div class="row g-0">
				<div class="">
					...
					<div style="display: flex; flex-direction: column; height: 100%;">
                        <div class="position-relative" id='position-relative_msg' style="max-height: 90%; overflow-y: auto;">
                        ...
                        <div class="position-sticky" style="background-color: #ffffff; padding: 10px; box-sizing: border-box;">
                            <div style="display: flex;">
                                <input type="text" id="message_submit" style="flex: 1; height: 40px; padding: 5px;">
