    ...
    <form action="/shop_search" method="get" id="search_shop">
        ...
        <div>
            <div class="condition-radio text-start">
                ...
                <div class="radio-group">
                    <div class="form-check pb-1">
                        <input class="form-check-input" type="radio" name="skill" value="both"><label class="form-check-label fw-bold">騎車</label>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid-item">
            <div class="limt">
                ...
                <div class="line">
                    ...
                    <a href="#" class="" id="{{ $shop->id }}" data-shop-id="{{ $shop->id }}" onclick="showPopup({{ $shop->id }})">回覆</a>
