    ...
    <div class="cut">
        <div class="grid-item">
            <div class="limt">
                ...
                @if(session('user_name')!=null)
                    <form id="replyForm" action="{{ route('artwork_reply_sumbit', ['mjoinid' => $mjoin->id]) }}" method="POST">
                        @csrf
                        ...
                        <button type="button" class="btn btn-primary" id="submitReply">留言</button>
                    </form>
                @endif
                ...
                <div class="ShowAllMessage">
                    <script>
                        ...
                        var submitButton = document.getElementById('submitReply');
                        ...
                        submitButton.addEventListener('click', function() {
                            ...
                            xhr.onreadystatechange = function() {
                                if (xhr.readyState === XMLHttpRequest.DONE) {
                                    if (xhr.status === 200) {
                                        // 请求成功
                                        console.log(xhr.responseText); // 如果需要的话，处理响应
                                    } else {
                                        // 请求失败
