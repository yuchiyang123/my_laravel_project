...
$(document).ready(function() {
    Echo.channel('chat{{ Auth::user()->id }}{{ $message->receiver_id }}')
        .listen('msg_outside', (e) => {
            ...
            // 构造新消息的 HTML 元素
            var newMessage = `
                <div class="d-flex flex-row align-items-center" id="message_show_d${e.fromUserId}">
                    <img src="https://github.com/mdo.png" style="width: 90px;" class="user_img_message" id="${e.message.sender_id}">
                    <div class="">
                        <div class="d-flex align-items-center fw-bold UserMassageBoxName">
