            ...
            <div class="limt">
                ...
                <div class="mb-3 text-start">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" value="無過敏" id="radio_none_preferences" name="preferences[]">
                ...
                <div class="mb-3 text-start">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" value="無過敏" id="radio_none" name="foodallergy[]">
                ...
                <div class="mb-3 text-start">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" value="沒有" id="radio_none_preferences" name="preferences[]">
                        <label class="form-check-label" for="radio_none">沒有</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="hiking" name="preferences[]" value="徒步旅行">
                        <label class="form-check-label" for="hiking">汽車</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="cycling" name="preferences[]" value="騎行">
                        <label class="form-check-label" for="cycling">機車</label>
                    </div>
                </div>
                <div class="mb-3 text-start">
                    <label class="post-title-label fw-bolder">聯絡方式：</label><br>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="contact_method_insite" name="contact_method[]" value="站內">
