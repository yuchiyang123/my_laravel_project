...
<main class="content vh-100">
    <div class="container p-0">
		<div class="card vh-100 d-flex">
			<div class="row g-0">
				<div class="">
					...
					<div class="position-relative" style="height: 100%;">
						<div class="chat-messages p-4 " style="height: 100%;">
							<div class="chat-message-right pb-4" style="height: 100%;">
								<div>
							...
							</div><div class="chat-message-left pb-4">
								<div>
									<img src="https://bootdey.com/img/Content/avatar/avatar3.png" class="rounded-circle mr-1" alt="Sharon Lessman" width="40" height="40">
									<div class="text-muted small text-nowrap mt-2">2:44 am</div>
								</div>
			...
			</div><div class="flex-grow-0 py-3 px-4 border-top bottom-container d-flex">
