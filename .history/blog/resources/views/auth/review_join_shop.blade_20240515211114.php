    ...
    <div class="cut">
        <div class="grid-item">
            <div class="limt">
                ...
                <div><a href="/user_score_all/{{ $review_join_user->username }}">使用者評分:@if($averageTotalScore!=0){{$averageTotalScore}}@else 尚未評分 @endif</a></div>
                @if(Auth::check())
                ...
                <div class="mb-3 pt-3">
                    ...
                    <div class="row">
                        <div class="col">
                            <form id="postForm" action="/review_shop_pass/{{ $review_join_shop->id }}" method="POST">
                                @csrf
