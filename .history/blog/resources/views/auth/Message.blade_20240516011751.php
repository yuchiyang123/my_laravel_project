        ...
        <a href="/message-view-show/{{ $userid }}" >
            <div id= "message_container">
                <div class="d-flex flex-row align-items-center" id="message_show_d{{ $userid }}">
                    @if($user_img->profileImage_type != null)
                        <img src="{{ $imageDataUri }}" style="width: 90px;" class="user_img_message rounded-circle" id="l_{{ $userid }}">
                    @else
                        <img src="https://github.com/mdo.png" style="width: 90px;" class="user_img_message rounded-circle" id="l_{{ $userid }}">
                    @endif
                    <div class="">
