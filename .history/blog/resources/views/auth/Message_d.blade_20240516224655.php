...
<main class="content">
    <div class="p-0">
        <div class="card vh-100 d-flex flex-column">
            <div class="row g-0 flex-grow-1">
                <div class="col">
                        ...
                        <div class="py-2 px-4 border-bottom d-none d-lg-block">
                            <div class="d-flex align-items-center py-1">
                                ...
                                <div class="position-relative">
                                    @if($user_img_1->profileImage_type != null)
                                        <img src="{{ $imageDataUri }}" class="rounded-circle me-2" width="40" height="40">
                                    @else
                    ...
                    <div class="position-relative overflow-auto flex-grow-1" id="position-relative_msg" style="max-height: calc(100% - 50px);">
                    ...
                    <div class="position-sticky bottom-0 start-0 w-100 bg-white p-3">
                        <div class="input-group">
                            <input type="text" id="message_submit" class="form-control" placeholder="Type your message..." onkeydown="handleKeyDown(event)">
                            <button class="btn btn-primary" type="button" onclick="sendMessage({{ $receiver_id }})">Send</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        // 页面加载时滚动到底部
        $('#position-relative_msg').scrollTop($('#position-relative_msg')[0].scrollHeight);
