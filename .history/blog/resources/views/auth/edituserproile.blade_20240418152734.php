        ...
        <div class="col-xl-4">
            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body text-center">
                    ...
                    <img id="profile-image" class="img-account-profile rounded-circle mb-2" src="http://bootdey.com/img/Content/avatar/avatar1.png" alt="">
    ...
    if (this.files && this.files[0]) {
        ...
        reader.onload = function(event) {
            ...
            image.onload = function() {
                var cropperModal = new Cropper(image, {
                ...
                $('#crop-button').click(function() {
                    // 获取裁剪后的图片数据
                    var canvas = cropperModal.getCroppedCanvas({
                        width: 160, // 预览图宽度
                        height: 160, // 预览图高度
                    });
