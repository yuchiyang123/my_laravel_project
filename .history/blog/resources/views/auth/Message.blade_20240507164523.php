    ...
    <div class="UserMassageBox">
        <a href="#">
            <div id="message_container">
                <div class="d-flex flex-row align-items-center" id="message_show_d_default">
                    <img src="{{ asset('image/head.png') }}" style="width: 90px;" class="user_img_message" id="l_default">
                    <div class="">
                        ...
                        <div class="d-flex align-items-center UserMassageBoxMessage">
                            <span class="">There are no messages to display.</span>
                        </div>
                    </div>
                </div>
            </div>
