        ...
        <div class="grid-item">
            <div class="limt">
                ...
                <div class="mb-3 text-start">
                    ...
                    <div id="imageContainer" class="mb-2" style="border: 1px solid #000; width: 800px; height: 360px;"></div>
                ...
                <div class="mb-3 text-start">
                    ...
                    <div id="imageContainer1" class="mb-2" style="border: 1px solid #000; width: 800px; height: 360px;"></div>
                    <div class="ui small basic icon buttons">
