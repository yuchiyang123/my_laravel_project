        ...
        <a href="/message-view-show/{{ $userid }}" >
            <div id= "message_container">
                <div class="d-flex flex-row align-items-center m-3" id="message_show_d{{ $userid }}">
                    @if($user_img->profileImage_type != null)
                        <img src="{{ $imageDataUri }}" style="width: 70px;" class="user_img_message rounded-circle" id="l_{{ $userid }}">
                    @else
                        <img src="https://github.com/mdo.png" style="width: 70px;" class="user_img_message rounded-circle" id="l_{{ $userid }}">
                    @endif
                    <div class="">
            ...
            var newMessage = `
                ...
                <div class="d-flex flex-row align-items-center" id="message_show_d${e.toUserId}">
                    @if($imageDataUri != null)
                        <img src="{{ $imageDataUri }}" style="width: 70px;" class="user_img_message rounded-circle" id="l_${e.toUserId}">
                    @else
                        <img src="https://github.com/mdo.png" style="width: 70px;" class="user_img_message rounded-circle" id="l_${e.toUserId}">
                    @endif
                    <div class="">
                        <div class="d-flex align-items-center fw-bold UserMassageBoxName">
