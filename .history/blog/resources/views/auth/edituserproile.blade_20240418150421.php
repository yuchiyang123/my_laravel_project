...
<script>
    ...
    dateFormat: "Y-m-d H:i:S", // 設置日期時間格式為年/月/日 時:分:秒
    onClose: function(selectedDates, dateStr, instance) {
        if (selectedDates.length === 1) { // 檢查是否選擇了日期
            const selectedDate = selectedDates[0]; // 取得選擇的日期
                    
            const formattedDate = selectedDate.toLocaleString("en-US", { year: 'numeric', month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit', second: '2-digit' });
