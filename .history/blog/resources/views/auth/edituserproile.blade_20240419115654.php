                ...
                <div class="card-body text-center">
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-header">
                            ...
                            <button id="clear-button" type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div id="cropper-container"><img id="original-image-modal" src="" alt=""></div>
                        </div>
                        <div class="modal-footer">
                            <button id="clear-button" type="button" class="btn btn-secondary" data-bs-dismiss="modal">取消</button>
            ...
            ClassicEditor
                ...
                $('#staticBackdrop').on('hidden.bs.modal', function (e) {
                    if (cropper) {
                        ...
                        cropper = null;  // 重置 Cropper 实例为 null
                    }
                });
