    ...
    <div class="grid-item">
        <div class="limt">
            ...
            <form action="" method="POST">
                <div class="LeaveMessageInput d-flex flex-row mb-3">
                    <div class="LeaveMessageInputrpAname p-2">
                        <img src="img/2-1.png" class="LeaveMessageUsernameIMG">
                    </div>
                    <div class="form-floating p-2 w-auto">
                        <textarea class="form-control" placeholder="留言" id="floatingTextarea_{{ $mjoin->id }}" name="MessageTextarea_{{ $mjoin->id }}" rows="3"></textarea>
                    </div>
                </div>
