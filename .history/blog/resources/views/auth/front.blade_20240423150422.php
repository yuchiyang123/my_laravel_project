            ...
            <div class="limt">
                ...
                <div class="line">
                    ...
                    @if(\App\Models\MjoinScore::where('rater_id', Auth::user()->id)->first() == null)
                        @if(\App\Models\UserPostMjoin::select('status')->where('posted_by_u', Auth::user()->username)->first()->status == 'complete' || 'del')
                    ...
                    <div class="inner-grid">
                        <a href="#" id="{{ $mjoin->id }}" data-mjoin-id="{{ $mjoin->id }}" onclick="showPopup({{ $mjoin->id }})">結束揪團</a>
                    </div>
