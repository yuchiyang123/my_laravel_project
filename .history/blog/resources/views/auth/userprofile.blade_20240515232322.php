                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex mb-3">
                                        ...
                                        @if($userrecord->username == Auth::user()->username && Auth::check())
                                            <div class="dropdown ms-2">
                                                <a href="#" class="dropdown-toggle font-size-16 text-muted" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <i class="mdi mdi-dots-horizontal"></i>
                                                </a>
                                                @php 
                                                $artwork_collect = DB::table('user_collections_artwork')->where('article_id',$userarkwork->id)->first();
                                                @endphp
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    @if(is_null($artwork_collect) ||$artwork_collect->status == '0')
                                                    收藏
                                                    @else
                                                    取消收藏
                                                    @endif
