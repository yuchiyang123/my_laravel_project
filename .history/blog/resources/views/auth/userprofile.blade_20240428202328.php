                            ...
                            <div class="row my-4">
                                <div class="col-md-12">
                                    <div>
                                        ...
                                        @endif
                                        @if($userinfo->social_links2 != null)
                                        ...
                                        @endif
                                        @if($userinfo->social_links3 != null)
                                        ...
                                        @endif
                                        @if($userinfo->social_links4 != null)
            ...
            <div class="tab-content p-4">
                <div class="tab-pane active show" id="projects-tab" role="tabpanel">
                    ...
                    <div class="row" id="all-projects">
                        ...
                        <div class="col-md-6" id="project-items-1">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <!---->
                                    <div>
                                        <?php $imageDataUri = 'data:' . $userCollections->image_type  . ';base64,' . base64_encode( $userCollections->image_data ); ?>
                                        @if($userCollections->image_data != null)
                                    ...
                                    <div class="mb-4">
                                        <a href="/arkwork_solo/solo/{{ $userCollections->id }}"><h4 class="mb-1 font-size-17 team-title pt-1">{{ $userCollections->title }}</h4></a>
                                        <p class="text-muted mb-0 team-description">
                                        {!! Str::limit(strip_tags($userCollections->main, '<p><a><br><b><strong><i><em><ul><ol><li><blockquote><code>'), 75, '...') !!}
                                        </p>
                                    </div>
                                    <div class="d-flex">
                                        <div class="avatar-group float-start flex-grow-1 task-assigne">
                                        <div class="flex-grow-1 align-items-start">
                                            <div>
                                                <h6 class="mb-0 text-muted">
                                                    <span class="team-date">{{ $userCollections->created_at }}</span>
                                                </h6>
                                            </div>
                                        ...
                                        <div class="align-self-end">
                                            <span class="badge badge-soft-danger p-2 team-status">{{ $userCollections->class }}</span>
                                        </div>
                                    </div><!---->
                                </div>
                                <!-- end cardbody -->
                        ...
                        @endif
                        @if(empty($userCollections_mjoin))
                        <div class="col-md-6" id="project-items-1">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <!---->
                                    <div>
                                        <?php $imageDataUri = 'data:' . $userCollections_mjoin->image_type  . ';base64,' . base64_encode( $userCollections_mjoin->image_data ); ?>
                                        @if($userCollections_mjoin->image_data != null)
                                    ...
                                    <div class="mb-4">
                                        <a href="/arkwork_solo/solo/{{ $userCollections_mjoin->description }}"><h4 class="mb-1 font-size-17 team-title pt-1">{{ $userCollections_mjoin->title }}</h4></a>
                                        <p class="text-muted mb-0 team-description">
                                        {!! Str::limit(strip_tags($userCollections_mjoin->main, '<p><a><br><b><strong><i><em><ul><ol><li><blockquote><code>'), 75, '...') !!}
                                        </p>
                                    </div>
                                    <div class="d-flex">
                                        <div class="avatar-group float-start flex-grow-1 task-assigne">
                                        <div class="flex-grow-1 align-items-start">
                                            <div>
                                                <h6 class="mb-0 text-muted">
                                                    <span class="team-date">{{ $userCollections_mjoin->created_at }}</span>
                                                </h6>
                                            </div>
                                        ...
                                        <div class="align-self-end">
                                            <span class="badge badge-soft-danger p-2 team-status">{{ $userCollections_mjoin->class }}</span>
                                        </div>
                                    </div><!---->
                                </div>
                                <!-- end cardbody -->
