        ...
        <div class="grid-item">
            <div class="limt">
                ...
                <div class="mb-3 text-start">
                    ...
                    @else
                        <input type="text" id="timePicker" name="recruitment_period" class="form-control datepicker" placeholder="請選擇時間" value="{{ $User_infor->age }}">
                    @endif
                ...
                <div class="mb-3 text-start">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" value="沒有" id="radio_none_license" name="license[]">
