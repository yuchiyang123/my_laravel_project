...
<div class="mb-3 text-start">
<label class="post-title-label3 fw-bolder text-start">詳細內容:</label></div>
<div class="LeaveMessageInput ">  
                                                <textarea neae="editor" id="editor" placeholder="請輸入內容" required></textarea> <!-- CKEditor 编辑器 -->
                                            </div>
</div>
</div>
</div>
