            ...
            <div id= "message_container">
                <div class="d-flex flex-row align-items-center" id="message_show_d{{ $userid }}">
                    @if($imageDataUri != null )
                        <img src="{{ $imageDataUri }}" style="width: 90px;" class="user_img_message" id="l_{{ $userid }}">
                    @else
                    <img class="img-fluid avatar-xxl rounded-circle"  style="width: 40px;" src="https://github.com/mdo.png" class="img-fluid" alt="">
                    @endif
                    <div class="">
