...
<div class="">
    ...
    <div>
        <a href="/message-view-show/@if{{ $message->user_id == Auth::user()->id ? $message->receiver_id : $message->user_id }}@else{{ $message->receiver_id }}@endif" id="message_show_a_{{ $message->receiver_id }}" >
