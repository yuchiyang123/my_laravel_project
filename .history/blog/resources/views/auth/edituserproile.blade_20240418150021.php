                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @if($user_public->user_sex_public == 0)
                                    <input name="sex_public" class="form-check-input" type="checkbox" value="1" id="flexCheckDefault">
                                    <label class="form-check-label" for="flexCheckDefault">
                                        公開
                                    </label>
                                @else
                                    <input name="sex_public" class="form-check-input" type="checkbox" value="1" id="flexCheckChecked" checked>
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @if($user_public->user_age_public == 0)
                                    <input name="age_public" class="form-check-input" type="checkbox" value="1" id="flexCheckDefault">
                                    <label class="form-check-label" for="flexCheckDefault">
                                        公開
                                    </label>
                                @else
                                    <input name="age_public" class="form-check-input" type="checkbox" value="1" id="flexCheckChecked" checked>
                                    <label class="form-check-label" for="flexCheckChecked">
                                        公開
                                    </label>
                                @endif
