                                    ...
                                    <div class="" id="project-items-1">
                                        <ul class="list-group">
                                            <li class="list-group-item">
                                                ...
                                                <a href="{{ route('mjoin_solo', ['mjoinId' => $item->id]) }}">{{ $item->title }}<span class="badge bg-primary rounded-pill">揪團</span></a>
                                                @else
                                                <a href="{{ route('shop_solo', ['shopId' => $item->id]) }}">{{ $item->shop_name }}<span class="badge bg-primary rounded-pill">打工</span></a>
                                                @endif
                                            </li>
