                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @if($user_public->user_sex_public == 0)
                                    ...
                                    <label name="sex_public" class="form-check-label" for="flexCheckDefault">
                                        公開
                                    </label>
                                @else
                                    <input class="form-check-input" type="checkbox" value="" id="flexCheckChecked" checked>
                        ...
                        <div class="row gx-3 mb-3">
                            <div class="col-md-6">
                                <div class="mb-3 text-start">
                                    <label class="small mb-1" for="timePicker">生日:</label>
                            ...
                            <div class="col-md-6">
                                ...
                                @if($user_public->user_age_public == 0)
                                    <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                                    <label name="age_public" class="form-check-label" for="flexCheckDefault">
                                        公開
                                    </label>
                                @else
                                    <input class="form-check-input" type="checkbox" value="" id="flexCheckChecked" checked>
                                    <label name="age_public" class="form-check-label" for="flexCheckChecked">
                                        公開
                                    </label>
                                @endif
                            </div>
                        </div>
                        <button class="btn btn-primary" type="button">更改</button>
                    </form>
                </div>
            </div>
        </div>
