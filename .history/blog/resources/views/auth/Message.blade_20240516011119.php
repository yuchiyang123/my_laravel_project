...
<div class="">
    ...
    @foreach ($messages as $message)
        @php
            ...
            $imageDataUri = 'data:' . $review_join_user->profileImage_type  . ';base64,' . base64_encode( $review_join_user->profileImage );
        @endphp
        ...
        <a href="/message-view-show/{{ $userid }}" >
            <div id= "message_container">
                <div class="d-flex flex-row align-items-center" id="message_show_d{{ $userid }}">
                    @if()
                    <img src="{{ asset('image/head.png') }}" style="width: 90px;" class="user_img_message" id="l_{{ $userid }}">
                    <div class="">
