...
<script>
    ...
    //偏好設定
    const radioNone = document.getElementById('radio_none_preferences');
    const checkboxes = document.querySelectorAll('.form-check-inline input[name="preferences[]"][type="checkbox"]');
