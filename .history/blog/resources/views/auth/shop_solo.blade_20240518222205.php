    ...
    <div class="cut">
        <div class="grid-item">
            <div class="limt">
                ...
                @endif
                <div class="post_condition fw-bolder border-bottom border-top pt-2 mt-1 mb-1 d-flex flex-row bd-highlight text-break" style="font-size: 14px;top:-30px;position:relative;">
