                            ...
                            <!--ul class="nav nav-tabs nav-tabs-custom border-bottom-0 mt-3 nav-justfied" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link px-4 active" data-bs-toggle="tab" href="#projects-tab" role="tab" aria-selected="false" tabindex="-1">
                                        ...
                                        <span class="d-none d-sm-block">創作</span>
                                    </a>
                                </li--><!-- end li -->
                                <!--li class="nav-item" role="presentation">
                ...
                <div class="tab-pane active show" id="projects-tab" role="tabpanel">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                            <h4 class="card-title mb-4 fw-bold me-auto">創作</h4>
                        </div>
                        <a type="button" href="{{ route('arkwork_post_form') }}" class="btn btn-primary btn">新增創作</a>
                    </div>

                    <div class="row" id="all-projects">
                        @foreach($userarkworks as $userarkwork)
                        <div class="col-md-6" id="project-items-1">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        <h5 class="mb-1 font-size-17 team-title">{{ $userarkwork->title }}</h5>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="align-self-end">
                                            <span class="badge badge-soft-success p-2 team-status">{{ $userarkwork->class }}</span>
                                        </div>
                                    </div><!---->
                                </div>
                                <!-- end cardbody -->
