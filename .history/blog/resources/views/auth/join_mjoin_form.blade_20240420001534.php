            ...
            <div class="limt">
                ...
                <div class="mb-3 text-start">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" value="無過敏" id="radio_none_preferences" name="preferences[]" selected>
                ...
                <div class="mb-3 text-start">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" value="無過敏" id="radio_none" name="foodallergy[]" selected>
                ...
                <div class="mb-3 text-start">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" value="Chinese" id="chineseCheckbox" name="languages[]" selected>
                ...
                <div class="mb-3 text-start">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" value="沒有" id="radio_none_license" name="license[]" selected>
                ...
                <div class="mb-3 text-start">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="contact_method_insite" name="contact_method[]" value="站內" selected>
