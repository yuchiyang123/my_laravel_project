        ...
        <div class="limt">
            ...
            <div class="line">
                ...
                <a href="#" data-mjoin-id="{{ $userarkworksolo->id }}" class="like-button">
                    ...
                    @if(Auth::check() && Auth::user()->username == $userarkworksolo->posted_by_u)
                    c class="dropdown">
                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                            更多
                        </a>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            <li><a class="dropdown-item" href="/mjoin_post_posts/edit/{{ $userarkworksolo->id }}">編輯</a></li>
                            <li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#exampleModal" href="#">刪除</a></li>
                            <li><a id="collect_{{ $userarkworksolo->id }}" class="dropdown-item" href="javascript:void(0);" data-mjoin-id="{{ $userarkworksolo->id }}" onclick="collect({{ $userarkworksolo->id }})">
                                @if($mjoin->status_b == 0)
                                    收藏
                            ...
                            <div class="modal-dialog mx-auto">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form action="/mjoin_post_posts/edit/delete/{{ $userarkworksolo->id }}" method="POST">
                                            @csrf
