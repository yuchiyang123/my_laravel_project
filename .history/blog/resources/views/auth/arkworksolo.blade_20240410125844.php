                ...
                <div class="inner-grid">
                    <form id="like-form" action="{{ route('posts.like', ['reply_id' => $userarkworksolo->id, 'great_code' => 'artwork']) }}" method="POST">
                        ...
                        @elseif($usersologood->many=="1")
                            <button type="submit" style="font-size: 20px;" class="ui icon" data-reply-id="{{ $userarkworksolo->id }}">
                                <ion-icon name="thumbs-up"></ion-icon>讚
                            </button>
                        @else
                            <button type="submit" style="font-size: 20px;" class="ui icon button" data-reply-id="{{ $userarkworksolo->id }}">
