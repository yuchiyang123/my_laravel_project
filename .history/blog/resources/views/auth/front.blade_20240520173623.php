                ...
                <div class="line">
                    ...
                    @php
                        if(Auth::check()){
                            ...
                            $user_post_mjoin = DB::table('mjoin')->where('id',$mjoin->id)->where('posted_by_u',Auth::user()->username)->where('status','<>',['del','complete'])->exists();

                            $user_post_mjoin_join = DB::table('join_mjoin')->where('article_id',$mjoin->id)->exists();
                            dd($user_post_mjoin,$user_post_mjoin_join);
                        }
                    @endphp
                    @if(Auth::check())
