...
<script>
    $(document).ready(function() {
        var 消息 = {!! json_encode($messages->first() ?? null) !!}; // 获取第一条消息或 null
        if(消息 !== null && 消息 !== undefined) {
            // 只有存在消息时才激活 WebSocket
            Echo.channel('chat{{ Auth::user()->id }}' + 消息.receiver_id)
