...
<div class="cut">
        <div class="grid-item">
            <div class="limt">
                ...
                <div class="mb-3 text-start ">
                    <label class="post-title-label fw-bolder">偏好旅遊方式:</label>
...
<script>
    ...
    const checkboxes = document.querySelectorAll('.form-check-inline input[type="checkbox"]');
