...
<script>
    ...
    links.each(function() {
        $(this).click(function(event) {
            ...
            // 获取超链接的 mjoinId
            var mjoinId = $(this).data('mjoin-id');

            // 检查超链接是否已经被喜欢
            if ($(this).hasClass('liked')) {
                ungood(mjoinId, $(this)); // 调用取消喜欢的函数
            } else {
                good(mjoinId, $(this)); // 调用喜欢的函数
            }
        });
                                    },
                                    error: function(xhr, status, error) {
     ...
     var links = document.querySelectorAll('.like-button');
    ...
    links.forEach(function(link) {
        link.addEventListener('click', function(event) {
            ...
            // 获取超链接的 mjoinId
            var mjoinId = link.getAttribute('data-mjoin-id');
