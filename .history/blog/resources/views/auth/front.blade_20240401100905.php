    ...
    <div class="grid-item">
        <div class="limt">
            ...
            <form action="" method="POST">
                <div class="LeaveMessageInput d-flex flex-row bd-highlight mb-3">
                    <div class="LeaveMessageInputrpAname p-2 bd-highlight">
                        <img  neae="LeaveMessageUsernameIMGreply" src="img/2-1.png" class="LeaveMessageUsernameIMG LeaveMessageUsernameIMGreply">
                    </div>
                    <div class="form-floating p-2 bd-highlight">
                        <textarea class="form-control  form-control-lg" placeholder="留言" id="floatingTextarea_{{ $mjoin->id }}" 
                            name="MessageTextarea_{{ $mjoin->id }}" rows="3"></textarea>
                    </div>
                </div>
                <button type="button" class="btn btn-primary" name="submit_{{ $mjoin->id }}">留言</button>
